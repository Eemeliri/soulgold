...
BPS_BASE ?= clean.gba
BPS_PATCH ?= soulgold_19boxes_BETA.bps
...
LEGACY_LEVEL_UP_TOOL := $(LEARNSET_HELPERS_DIR)/preview_legacy_levelups.py
LEGACY_LEVEL_UP_CONFIG := $(DATA_SRC_SUBDIR)/pokemon/legacy_level_up_config.json
LEGACY_LEVEL_UP_CURRENT := $(DATA_SRC_SUBDIR)/pokemon/level_up_learnsets/gen_9.h
LEGACY_LEVEL_UP_SOURCE := $(DATA_SRC_SUBDIR)/pokemon/level_up_learnsets/gen_7.h
LEGACY_LEVEL_UP_HEADER := $(DATA_SRC_SUBDIR)/pokemon/level_up_learnsets/generated_legacy_level_up_learnsets.h
...
$(LEGACY_LEVEL_UP_HEADER): $(LEGACY_LEVEL_UP_CURRENT) $(LEGACY_LEVEL_UP_SOURCE) $(LEGACY_LEVEL_UP_CONFIG) $(LEGACY_LEVEL_UP_TOOL) $(INCLUDE_DIRS)/constants/moves.h $(INCLUDE_DIRS)/constants/pokemon.h
	python3 $(LEGACY_LEVEL_UP_TOOL) --current $(LEGACY_LEVEL_UP_CURRENT) --legacy $(LEGACY_LEVEL_UP_SOURCE) --config $(LEGACY_LEVEL_UP_CONFIG) --output $@
...
$(C_BUILDDIR)/pokemon.o: $(C_SUBDIR)/pokemon.c $(DATA_SRC_SUBDIR)/pokemon/teachable_learnsets.h $(LEGACY_LEVEL_UP_HEADER)
...
$(DATA_SRC_SUBDIR)/tutor_moves.h: $(DATA_SRC_SUBDIR)/pokemon/special_movesets.json $(LEARNSET_HELPERS_DIR)/make_teachables.py | $(ALL_TUTORS_JSON)
