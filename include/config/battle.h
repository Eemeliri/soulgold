...
#define B_MODERN_TRAINER_EXP_PERCENT 120       // Percentage of regular EXP awarded in modern trainer battles.
...
#define B_FAST_INTRO_NO_SLIDE               FALSE // Default value for the option that skips the slide animation at the beginning of battle.
#define B_FAST_MEGAS                        FALSE // Default value for the option that makes Mega Evolution animation near-instant.
#define B_FAST_WEATHER                      FALSE // Default value for the option that skips recurring weather messages and animations.
...
#define B_FLAG_VICTORY_CATCH_RANDOM     FLAG_POSTBATTLE_CATCH          // If set, you will be prompted to throw a ball after the encounter has been defeated, catch rate is random. You can't capture the encounter in any other way
#define B_FLAG_VICTORY_CATCH_GUARANTEED FLAG_POSTBATTLE_CATCH_GUARANTEED          // If set, you will be prompted to throw a ball after the encounter has been defeated, guaranteed to catch. You can't capture the encounter in any other way
