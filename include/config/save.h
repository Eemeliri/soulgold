...
#define POKEMON_STORAGE_EXTENSION_TAIL_BYTES 1944
#define SAVEBLOCK1_FUTURE_RESERVED_BYTES    (2048 - 48 - SAVEBLOCK_MULTIREG_ITEMS - SAVEBLOCK_REGISTERED_SHORTCUTS - 2 - POKEMON_STORAGE_EXTENSION_TAIL_BYTES)
