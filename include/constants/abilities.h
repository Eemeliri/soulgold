...
enum __attribute__((packed)) Ability
{
    ...
    ABILITY_INVERSION = 311,
    ABILITY_FIGHTING_ATE = 312,
    ABILITY_POISON_ATE = 313,
    ABILITY_GROUND_ATE = 314,
    ABILITY_ROCK_ATE = 315,
    ABILITY_BUG_ATE = 316,
    ABILITY_GHOST_ATE = 317,
    ABILITY_STEEL_ATE = 318,
    ABILITY_FIRE_ATE = 319,
    ABILITY_WATER_ATE = 320,
    ABILITY_GRASS_ATE = 321,
    ABILITY_PSYCHIC_ATE = 322,
    ABILITY_DRAGON_ATE = 323,
    ABILITY_DARK_ATE = 324,
    ABILITY_STEEL_FEET = 325,
    ABILITY_DUAL_STRIKE = 326,
    ABILITY_UNSTOPPABLE = 327,
    ABILITY_UNCANNY = 328,
    ABILITY_MYSTIC_FORCE = 329,
    ABILITY_MANEUVERABILITY = 330,
    ABILITY_ADRENALINE = 331,
    ABILITY_PACK_LEADER = 332,
    ABILITY_REACTIVE = 333,
    ABILITY_TRUE_GRIT = 334,
    ABILITY_WARRIOR_SPIRIT = 335,
    ABILITY_WIND_FORCE = 336,
    ABILITY_TOXIC_CORE = 337,
    ABILITY_EARTHBOUND = 338,
    ABILITY_HIVE_FORCE = 339,
    ABILITY_SPECTRAL_FORCE = 340,
    ABILITY_FIERY_HEART = 341,
    ABILITY_SEABOUND = 342,
    ABILITY_VERDANT_SOUL = 343,
    ABILITY_MIND_FORCE = 344,
    ABILITY_FROST_FORCE = 345,
    ABILITY_NIGHTFALL = 346,
    ABILITY_FAE_HEART = 347,
    ABILITY_PLANTATION = 348,
    ABILITY_ECHOING = 349,
    ABILITY_TIRELESS = 350,
    ABILITY_AURA_SHIELD = 351,
    ABILITY_PLAIN_SOUL = 352,
    ABILITY_FIGHTER_SOUL = 353,
    ABILITY_WIND_SOUL = 354,
    ABILITY_VENOM_SOUL = 355,
    ABILITY_EARTH_SOUL = 356,
    ABILITY_STONE_SOUL = 357,
    ABILITY_HIVE_SOUL = 358,
    ABILITY_PHANTOM_SOUL = 359,
    ABILITY_STEEL_SOUL = 360,
    ABILITY_FLAME_SOUL = 361,
    ABILITY_SEA_SOUL = 362,
    ABILITY_VERDANT_SOUL_TYPE = 363,
    ABILITY_THUNDER_SOUL = 364,
    ABILITY_MIND_SOUL = 365,
    ABILITY_FROST_SOUL = 366,
    ABILITY_DRAGON_SOUL = 367,
    ABILITY_NIGHT_SOUL = 368,
    ABILITY_FAE_SOUL = 369,
    ABILITY_SHOWTIME = 370,
    ABILITY_ROOTED = 371,
    ABILITY_RESTORING = 372,
    ABILITY_READY_STANCE = 373,
    ABILITY_FIRST_STRIKE = 374,
    ABILITY_TOXIC_REFLEX = 375,
    ABILITY_EARTHEN_RUSH = 376,
    ABILITY_STONE_SENTINEL = 377,
    ABILITY_SWARM_INSTINCT = 378,
    ABILITY_PHANTOM_STEP = 379,
    ABILITY_QUICK_FORGE = 380,
    ABILITY_FLAME_RUSH = 381,
    ABILITY_TIDAL_REFLEX = 382,
    ABILITY_VERDANT_GALE = 383,
    ABILITY_STATIC_BURST = 384,
    ABILITY_THINK_AHEAD = 385,
    ABILITY_FROST_SNAP = 386,
    ABILITY_DRACONIC_REFLEX = 387,
    ABILITY_NIGHT_STALKER = 388,
    ABILITY_FAIRY_BLINK = 389,
    ABILITY_ELEMENTAL_FIST = 390,
    ABILITY_ELEMENTALIST = 391,
    ABILITY_SOOTHING = 392,
    ABILITY_ROLLING_STONE = 393,
    ABILITY_GENERALIST = 394,
    ABILITY_WINDBURST = 395,
    ABILITY_BATTLE_FERVOR = 396,
    ABILITY_GUARD_STANCE = 397,
    ABILITY_MENTAL_SURGE = 398,
    ABILITY_RESOLUTE_GUARD = 399,
    ABILITY_SKIP_STEP = 400,
    ABILITY_BREAKING_PRESENCE = 401,
    ABILITY_DISQUIET = 402,
    ABILITY_HOBBLE = 403,
    ABILITY_SEER = 404,
    ABILITY_SMOULDERING = 405,
    ABILITY_CONSUME = 406,
    ABILITY_LIFESTEAL = 407,
    ABILITY_HAUNTING = 408,
    ABILITY_WINDCALLER = 409,
    ABILITY_SIEGEBREAKER = 410,
    ABILITY_SANDSHIELD = 411,
    ABILITY_JADE_BLOOM = 412,
    ABILITY_BRIMSTONE = 413,
    ABILITY_STYGIAN = 414,
    ABILITY_OMEGA = 415,
    ABILITY_PERMAFROST = 416,
    ABILITY_STONE_FACE = 417,
    ABILITY_VOIDTOUCH = 418,
    ABILITY_GLACIAL = 419,
    ABILITY_LUNAR_CYCLE = 420,
    ABILITY_FROST_NOVA = 421,
    ABILITY_SHOCKWIRING = 422,
    ABILITY_RITUAL = 423,
    ABILITY_OVERLOCK = 424,
    ABILITY_SPECTRAL_DRAIN = 425,
    ABILITY_BLAZING_SUN = 426,
    ABILITY_OVERLOAD = 427,
    ABILITY_FILL_VOID = 428,
    ABILITY_DUST_DEVIL = 429,
    ABILITY_SOLIDIFY = 430,
    ABILITY_UNLEASHED = 431,
    ABILITY_TETHER = 432,
    ABILITY_SOLAR_PANEL = 433,
    ABILITY_INFERNAL = 434,
    ABILITY_REEF_WARDEN = 435,
    ABILITY_SOLAR_ARMOR = 436,
    ABILITY_ABYSSAL_VEIL = 437,
    ABILITY_PLASMA_SURGE = 438,
    ABILITY_PHALANX = 439,
    ABILITY_SPECTRAL = 440,
    ABILITY_SUNHARDENED = 441,
    ABILITY_HEATSTORM = 442,
    ABILITY_COALWALKER = 443,
    ABILITY_LAVA_SURFER = 444,
    ABILITY_ASH_ASSETS = 445,
    ABILITY_FORCE_RETURN = 446,
    ABILITY_ENIGMA = 447,
    ABILITY_BURROWER = 448,
    ABILITY_DIVER = 449,
    ABILITY_LAST_STAND = 450,
    ABILITY_HUNTER = 451,
    ABILITY_NINE_LIVES = 452,
    ABILITY_DEBILITATE = 453,
    ABILITY_TITAN_GRIP = 454,
    ABILITY_FLEXIBLE = 455,
    ABILITY_REBORN = 456,
    ABILITY_REJUVENATION = 457,
    ABILITY_TIDAL_DEITY = 458,
    ABILITY_ROCKSTORM = 459,
    ABILITY_STORMRIDER = 460,
    ABILITY_VOLCANO_HOWL = 461,
    ABILITY_ARCTIC_AURA = 462,
    ABILITY_BLOODLUST = 463,
    ABILITY_GANG_UP = 464,
    ABILITY_PENDULUM = 465,
    ABILITY_MOMENTUM = 466,
    ABILITY_DESPERADO = 467,
    ABILITY_GLASS_CANNON = 468,
    ABILITY_AEGIS = 469,
    ABILITY_MARTYR = 470,
    ABILITY_INDOMITABLE = 471,
    ABILITY_COLOSSAL = 472,
    ABILITY_PARRYING = 473,
    ABILITY_FAINTRATTLE = 474,
    ABILITY_SHARDPLATE = 475,
    ABILITY_HAUNTED = 476,
    ABILITY_MENDING = 477,
    ABILITY_PLAGUETOUCH = 478,
    ABILITY_MONSOON = 479,
    ABILITY_MIRAGE = 480,
    ABILITY_BLIZZARD_HEART = 481,
    ABILITY_MUDSLIDE = 482,
    ABILITY_CHANNEL_EARTH = 483,
    ABILITY_MAGNIFY_FIELD = 484,
    ABILITY_BLITZ = 485,
    ABILITY_GUARDIAN = 486,
    ABILITY_BACKDRAFT = 487,
    ABILITY_RALLY = 488,
    ABILITY_ECHO_CHAMBER = 489,
    ABILITY_FLARE = 490,
    ABILITY_SPLINTER = 491,
    ABILITY_MAIM_AND_MEND = 492,
    ABILITY_VALKYRIE = 493,
    ABILITY_IMMOVABLE = 494,
    ABILITY_TRANSMUTE = 495,
    ABILITY_TWIN_STARS = 496,
    ABILITY_COSMIC_FORM = 497,
    ABILITY_TIME_SPIRAL = 498,
    ABILITY_NULL_SPACE = 499,
    ABILITY_SPACETIME_RIFT = 500,
    ABILITY_UNDERDOG = 501,
    ABILITY_ROCK_AND_STONE = 502,
    ABILITY_POLARITY_SHIFT = 503,
    ABILITY_HORSE_COUNCIL = 504,
    ABILITY_POWER_SHIFT = 505,
    ABILITY_WISHMAKER = 506,
    ABILITY_FLIER = 507,
    ABILITY_FLAMEBURST = 508,
    ABILITY_INKY = 509,
    ABILITY_BRAND_OF_TORMENT = 510,
    ABILITY_DRAGONIZE = 511,
    ABILITY_EELEVATE = 512,
    ABILITY_MEGA_SOL = 513,
    ABILITY_SPICY_SPRAY = 514,
    ABILITY_WIND_CHIME = 515,
    ABILITY_GRAVITY_WELL = 516,
    ABILITY_ALLSEEING_IDOL = 517,
    ABILITY_ACIDIC = 518,
    ABILITY_AURA_GUARD = 519,
    ABILITY_LIKE_A_DRAGON = 520,
    ABILITY_ELECTROLEVITATE = 521,
    ABILITY_MALICE_AURA = 522,
    ABILITY_OGRE_FORCE = 523,
    ABILITIES_COUNT_GEN9,
    ABILITIES_COUNT = ABILITIES_COUNT_GEN9,
};

#define ABILITY_FIRE_MANE ABILITY_FIERY_HEART
