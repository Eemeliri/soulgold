...
#define SPECIAL_BATTLE_LANCE 3
#define SPECIAL_BATTLE_MULTI 4
...
#define BATTLE_CAFE_MODE_ENDLESS_CHALLENGE 4
#define BATTLE_CAFE_MODE_ENDLESS_RUSH      5

#define BATTLE_CAFE_MAX_POINTS MAX_BATTLE_FRONTIER_POINTS
#define BATTLE_CAFE_MAX_STREAK MAX_STREAK
#define BATTLE_CAFE_ENDLESS_MASTER_STREAK 15

#define BATTLE_CAFE_VITAMIN_SET_ATK 0
#define BATTLE_CAFE_VITAMIN_SET_DEF 1
#define BATTLE_CAFE_VITAMIN_SET_SPE 2

#define BATTLE_CAFE_VITAMIN_PURCHASE_SUCCESS           0
#define BATTLE_CAFE_VITAMIN_PURCHASE_NOT_ENOUGH_POINTS 1
#define BATTLE_CAFE_VITAMIN_PURCHASE_NO_BAG_SPACE      2
#define BATTLE_CAFE_VITAMIN_PURCHASE_INVALID_SET       3

#define BATTLE_CAFE_PARADOX_REWARD_MIRAIDON (1 << 0)
#define BATTLE_CAFE_PARADOX_REWARD_KORAIDON (1 << 1)
