...
#define FLAG_HIDDEN_ITEM_ROUTE29_ETHER                      (FLAG_HIDDEN_ITEMS_START + 0x00)
#define FLAG_HIDDEN_ITEM_TRICK_HOUSE_NUGGET                  (FLAG_HIDDEN_ITEMS_START + 0x01)
#define FLAG_HIDDEN_ITEM_CHERRYGROVE_STARDUST                (FLAG_HIDDEN_ITEMS_START + 0x02)
#define FLAG_HIDDEN_ITEM_ROUTE30_FULL_HEAL                   (FLAG_HIDDEN_ITEMS_START + 0x03)
#define FLAG_HIDDEN_ITEM_ROUTE30_POTION                      (FLAG_HIDDEN_ITEMS_START + 0x04)
#define FLAG_HIDDEN_ITEM_ROUTE31_ANTIDOTE                   (FLAG_HIDDEN_ITEMS_START + 0x05)
#define FLAG_HIDDEN_ITEM_ROUTE30_NUGGET                      (FLAG_HIDDEN_ITEMS_START + 0x06)
#define FLAG_HIDDEN_ITEM_ROUTE32_GREAT_BALL                  (FLAG_HIDDEN_ITEMS_START + 0x07)
#define FLAG_HIDDEN_ITEM_RUINSOFALPH_RARECANDY               (FLAG_HIDDEN_ITEMS_START + 0x08)
#define FLAG_HIDDEN_ITEM_ROUTE33_ETHER                       (FLAG_HIDDEN_ITEMS_START + 0x09)
#define FLAG_HIDDEN_ITEM_ILEX_MUSHROOM                       (FLAG_HIDDEN_ITEMS_START + 0x0A)
#define FLAG_HIDDEN_ITEM_ILEX_PPUP                           (FLAG_HIDDEN_ITEMS_START + 0x0B)
#define FLAG_HIDDEN_ITEM_ROUTE34_ULTRABALL                   (FLAG_HIDDEN_ITEMS_START + 0x0C)
#define FLAG_HIDDEN_ITEM_ROUTE34_AWAKENING                   (FLAG_HIDDEN_ITEMS_START + 0x0D)
#define FLAG_HIDDEN_ITEM_ROUTE35_STARDUST                    (FLAG_HIDDEN_ITEMS_START + 0x0E)
#define FLAG_HIDDEN_ITEM_ROUTE36_CARBOS                      (FLAG_HIDDEN_ITEMS_START + 0x0F)
#define FLAG_HIDDEN_ITEM_ROUTE37_FULL_HEAL                   (FLAG_HIDDEN_ITEMS_START + 0x10)
#define FLAG_HIDDEN_ITEM_ROUTE38_HP_UP                       (FLAG_HIDDEN_ITEMS_START + 0x11)
#define FLAG_HIDDEN_ITEM_ROUTE38_REVIVE                      (FLAG_HIDDEN_ITEMS_START + 0x12)
#define FLAG_HIDDEN_ITEM_BURNED_TOWER_BURNHEAL               (FLAG_HIDDEN_ITEMS_START + 0x13)
#define FLAG_HIDDEN_ITEM_BURNED_TOWER_CALCIUM                (FLAG_HIDDEN_ITEMS_START + 0x14)
#define FLAG_HIDDEN_ITEM_ROUTE42_DUSK_BALL                   (FLAG_HIDDEN_ITEMS_START + 0x15)
#define FLAG_HIDDEN_ITEM_ROUTE39_HYPER_POTION                (FLAG_HIDDEN_ITEMS_START + 0x16)
#define FLAG_HIDDEN_ITEM_ROUTE40_PARALYZ_HEAL                (FLAG_HIDDEN_ITEMS_START + 0x17)
#define FLAG_HIDDEN_ITEM_ROUTE41_QUIET_MINT                  (FLAG_HIDDEN_ITEMS_START + 0x18)
#define FLAG_HIDDEN_ITEM_ROUTE43_QUICK_BALL                  (FLAG_HIDDEN_ITEMS_START + 0x19)
#define FLAG_HIDDEN_ITEM_LAKEOFRAGE_RARE_CANDY               (FLAG_HIDDEN_ITEMS_START + 0x1A)
#define FLAG_HIDDEN_ITEM_ICEPATH_PP_MAX                      (FLAG_HIDDEN_ITEMS_START + 0x1B)
#define FLAG_HIDDEN_ITEM_ICEPATH_ELIXIR                      (FLAG_HIDDEN_ITEMS_START + 0x1C)
#define FLAG_HIDDEN_ITEM_BLACKTHORNE_PROTEIN                 (FLAG_HIDDEN_ITEMS_START + 0x1D)
#define FLAG_HIDDEN_ITEM_ROUTE45_FULL_RESTORE                (FLAG_HIDDEN_ITEMS_START + 0x1E)
...
#define FLAG_HIDDEN_ITEM_ROUTE48_IRON                        (FLAG_HIDDEN_ITEMS_START + 0x28)
#define FLAG_HIDDEN_ITEM_KITAKAMIBORDER_ZINC                 (FLAG_HIDDEN_ITEMS_START + 0x29)
#define FLAG_HIDDEN_ITEM_UNION_CAVE1_LEPPA                   (FLAG_HIDDEN_ITEMS_START + 0x2A)
#define FLAG_HIDDEN_ITEM_ROUTE44_MAX_REVIVE                  (FLAG_HIDDEN_ITEMS_START + 0x2B)
#define FLAG_HIDDEN_ITEM_UNIONCAVE3_REDCARD                  (FLAG_HIDDEN_ITEMS_START + 0x2C)
#define FLAG_HIDDEN_ITEM_DARKCAVE_ETHER                      (FLAG_HIDDEN_ITEMS_START + 0x2D)
#define FLAG_HIDDEN_ITEM_DARKCAVE_BIGPEARL                   (FLAG_HIDDEN_ITEMS_START + 0x2E)
#define FLAG_HIDDEN_ITEM_ROUTE49_REVIVE                      (FLAG_HIDDEN_ITEMS_START + 0x2F)
#define FLAG_HIDDEN_ITEM_ROUTE49_SITRUS_BERRY                (FLAG_HIDDEN_ITEMS_START + 0x30)
#define FLAG_HIDDEN_ITEM_SNOWTOPOUT_SUPERREPEL               (FLAG_HIDDEN_ITEMS_START + 0x31)
#define FLAG_HIDDEN_ITEM_SNOWTOPIN_STAR_PIECE                (FLAG_HIDDEN_ITEMS_START + 0x32)
#define FLAG_HIDDEN_ITEM_VAJRADESERT_FULL_HEAL               (FLAG_HIDDEN_ITEMS_START + 0x33)
#define FLAG_HIDDEN_ITEM_VICTORYROAD_MAX_REPEL               (FLAG_HIDDEN_ITEMS_START + 0x34)
#define FLAG_HIDDEN_ITEM_VICTORYROAD_PP_MAX                  (FLAG_HIDDEN_ITEMS_START + 0x35)
#define FLAG_HIDDEN_ITEM_ROUTE28_MAX_REVIVE                  (FLAG_HIDDEN_ITEMS_START + 0x36)
#define FLAG_HIDDEN_ITEM_ROUTE27_REVIVE                      (FLAG_HIDDEN_ITEMS_START + 0x37)
...
#define FLAG_HIDE_RIVAL_MARILL                      0x940
#define FLAG_HIDE_RIVAL_AZUMARILL                   0x941
#define FLAG_CAMERON_PHOTO1                         0x942
#define FLAG_CAMERON_PHOTO2                         0x943
...
#define FLAG_RAGINGDOOR        0x100A
#define FLAG_GOUGINGDOOR       0x100B
#define FLAG_WALKINGDOOR       0x100C
#define FLAG_HIDE_RAGINGBOLT   0x100D
#define FLAG_HIDE_GOUGINGFIRE  0x100E
#define FLAG_HIDE_WALKINGWAKE  0x100F
#define FLAG_HIDE_FLUTTERMANE  0x1010
#define FLAG_ALL_PASTMONS      0x1011
#define FLAG_ALL_FUTUREMONS    0x1012
#define FLAG_LEAVESDOOR        0x1013
#define FLAG_BOULDERDOOR       0x1014
#define FLAG_CROWNDOOR         0x1015
...
#define FLAG_BATTLE_CAFE_TORNADUS_RECEIVED      0x1027
...
#define FLAG_BATTLE_CAFE_ENDLESS_CHALLENGE_UNLOCKED 0x102F
#define FLAG_BATTLE_CAFE_ENDLESS_RUSH_UNLOCKED      0x1030
#define FLAG_BATTLE_FACILITY_NO_INNATES             0x1031
#define FLAG_BATTLE_CAFE_MIRAIDON_RECEIVED          0x1032
#define FLAG_BATTLE_CAFE_KORAIDON_RECEIVED          0x1033
#define FLAG_BATTLE_CAFE_TAPU_KOKO_RECEIVED         0x1034
...
#define FLAG_DAILY_BATTLE_CAFE_SIMPLI                 (DAILY_FLAGS_START + 0x22)
