...
#define ITEM10_REDUCE_IV        0x80

#define ITEM10_IVS_ALL          (ITEM10_IV_HP | ITEM10_IV_ATK | ITEM10_IV_DEF | ITEM10_IV_SPEED | ITEM10_IV_SPDEF | ITEM10_IV_SPATK)

// field 9 parameters for ITEM10_REDUCE_IV. Zero means no IV reduction.
#define ITEM9_REDUCE_IV_HP      (STAT_HP + 1)
#define ITEM9_REDUCE_IV_ATK     (STAT_ATK + 1)
#define ITEM9_REDUCE_IV_DEF     (STAT_DEF + 1)
#define ITEM9_REDUCE_IV_SPEED   (STAT_SPEED + 1)
#define ITEM9_REDUCE_IV_SPATK   (STAT_SPATK + 1)
#define ITEM9_REDUCE_IV_SPDEF   (STAT_SPDEF + 1)
...
enum ItemEffectType
{
    ...
    ITEM_EFFECT_HP_IV_REDUCE,
    ITEM_EFFECT_ATK_IV_REDUCE,
    ITEM_EFFECT_DEF_IV_REDUCE,
    ITEM_EFFECT_SPEED_IV_REDUCE,
    ITEM_EFFECT_SPATK_IV_REDUCE,
    ITEM_EFFECT_SPDEF_IV_REDUCE,
