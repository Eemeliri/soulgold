...
enum __attribute__((packed)) Item
{
    ...
    ITEM_LOST_ITEM = 876,
    ITEM_MACHINE_PART = 877,
    ITEM_MYSTERY_EGG = 878,
    ITEM_PASS = 879,
    ITEM_RAINBOW_WING = 880,
    ITEM_RED_SCALE = 881,
    ITEM_SECRET_POTION = 882,
    ITEM_SILVER_WING = 883,
    ITEM_CLEAR_BELL = 884,
    ITEM_TIDAL_BELL = 885,
    ITEM_RADIO = 886,
    ITEM_CANDY_JAR = 887,
