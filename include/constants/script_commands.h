...
enum ScrOp
{
    ...
    SCR_OP_APPLYMOVEMENT2 = 0xE6,
    SCR_OP_GIVENAMEDMON = 0xE7,
    SCR_OP_REMOVENAMEDMON = 0xE8,
    SCR_OP_REMOVE5MONS = 0xE9,
    SCR_OP_SETWILDBATTLESHINY = 0xEA,
    SCR_OP_REMOVEGENERICMON = 0xEB,
    SCR_OP_BAOBACHECKMON = 0xEC,
    SCR_OP_GIVEODDEGG = 0xED,
    SCR_OP_GIVEBP = 0xEE,
    SCR_OP_CHECKPARTYMONLEVEL = 0xEF,
};
