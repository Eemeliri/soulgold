...
STATIC_ASSERT(FLAG_INFINITE_HELD_ITEMS_MIGRATION_COMPLETE != FLAG_SYS_POKEMON_GET, InfiniteHeldItemsMigrationFlagOverlapsPokemonGet);
STATIC_ASSERT(FLAG_INFINITE_HELD_ITEMS_MIGRATION_COMPLETE == FLAG_NATIONAL_DEX_MIGRATION_COMPLETE + 1, InfiniteHeldItemsMigrationFlagMustFollowNationalDexMigration);
...
struct SaveBlock1
{
    ...
    /*0x2B95*/ u8 vsSeekerSaveMagic;
    /*0x2B96*/ u16 vsSeekerChargeSteps;
    /*0x2B98*/ u16 outbreakPokemonMoves[MAX_MON_MOVES];
    /*0x2BA0*/ u8 vsSeekerSaveMagicInv;
