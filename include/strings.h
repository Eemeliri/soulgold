...
extern const u8 gText_PkmnVar2IVWasLowered[];
...
extern const u8 gText_PkmnDroppedToLvVar2[];
...
extern const u8 gPCText_Etcetera1[];
extern const u8 gPCText_Etcetera2[];
extern const u8 gPCText_Etcetera3[];
extern const u8 gPCText_Etcetera4[];
...
extern const u8 gPCText_Space[];
extern const u8 gPCText_Backyard[];
extern const u8 gPCText_Nostalgic1[];
extern const u8 gPCText_Torchic[];
extern const u8 gPCText_Trio1[];
extern const u8 gPCText_PikaPika1[];
extern const u8 gPCText_TimeAndSpace[];
extern const u8 gPCText_Galactic1[];
extern const u8 gPCText_Distortion[];
extern const u8 gPCText_Contest[];
extern const u8 gPCText_Nostalgic2[];
extern const u8 gPCText_Croagunk[];
extern const u8 gPCText_Trio2[];
extern const u8 gPCText_PikaPika2[];
extern const u8 gPCText_Renegade[];
extern const u8 gPCText_Galactic2[];
extern const u8 gPCText_Heart[];
extern const u8 gPCText_Soul[];
extern const u8 gPCText_BigBrother[];
extern const u8 gPCText_Pokeathlon[];
extern const u8 gPCText_Trio3[];
extern const u8 gPCText_SpikyPika[];
extern const u8 gPCText_KimonoGirl[];
extern const u8 gPCText_Revival[];
