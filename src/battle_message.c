...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNUNLOCKEDINNATE]                   = COMPOUND_STRING("{B_BUFF1} unlocked innate potential:\n{B_BUFF2}!{WAIT_SE}\p"),
    ...
    [STRINGID_PKMNSCORCHEDBYFIELD]                  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is scorched by the burning field!"),
    ...
    [STRINGID_SCORCHEDFIELDSETTLED]                 = COMPOUND_STRING("The scorched field settled."),
    ...
    [STRINGID_SCORCHEDFIELDSTARTED]                 = COMPOUND_STRING("The field became scorched!"),
    [STRINGID_HAILCONTINUES]                        = COMPOUND_STRING("The hail is crashing down."),
    [STRINGID_SCORCHEDFIELDBLAZES]                  = COMPOUND_STRING("The scorched field blazes."),
    [STRINGID_TWILIGHTSTARTED]                      = COMPOUND_STRING("Twilight fell over the battlefield!"),
    [STRINGID_TWILIGHTENDED]                        = COMPOUND_STRING("The twilight faded."),
    [STRINGID_TWILIGHTCONTINUES]                    = COMPOUND_STRING("The twilight deepens."),
    ...
    [STRINGID_GOTCHAPKMNCAUGHTPLAYER]               = COMPOUND_STRING("Gotcha! {B_DEF_NAME} was caught!{WAIT_SE}{PLAY_BGM MUS_HG_CAUGHT}\p"),
    [STRINGID_GOTCHAPKMNCAUGHTWALLY]                = COMPOUND_STRING("Gotcha! {B_DEF_NAME} was caught!{WAIT_SE}{PLAY_BGM MUS_HG_CAUGHT}{PAUSE 127}"),
    [STRINGID_GIVENICKNAMECAPTURED]                 = COMPOUND_STRING("What would you like to do with {B_DEF_NAME}?"),
...
const u16 gStartingStatusStringIds[B_MSG_STARTING_STATUS_COUNT] =
{
    ...
    [B_MSG_TERRAIN_SET_SCORCHED] = STRINGID_SCORCHEDFIELDSTARTED,
...
const u16 gTerrainStringIds[B_MSG_TERRAIN_COUNT] =
{
    ...
    [B_MSG_TERRAIN_END_SCORCHED] = STRINGID_SCORCHEDFIELDSETTLED,
};
...
const u16 gMoveWeatherChangeStringIds[] =
{
    ...
    [B_MSG_STARTED_TWILIGHT] = STRINGID_TWILIGHTSTARTED,
};
...
const u16 gWeatherEndsStringIds[B_MSG_WEATHER_END_COUNT] =
{
    ...
    [B_MSG_WEATHER_END_TWILIGHT] = STRINGID_TWILIGHTENDED,
};
...
const u16 gWeatherTurnStringIds[] =
{
    ...
    [B_MSG_WEATHER_TURN_TWILIGHT] = STRINGID_TWILIGHTCONTINUES,
};
...
const u16 gSandStormHailDmgStringIds[] =
{
    ...
    [B_MSG_SCORCHED_FIELD] = STRINGID_PKMNSCORCHEDBYFIELD,
};
