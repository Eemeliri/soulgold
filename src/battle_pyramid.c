...
static const struct PyramidTrainerEncounterMusic sTrainerClassEncounterMusic[] =
{
    ...
    {TRAINER_CLASS_AROMA_LADY, TRAINER_ENCOUNTER_MUSIC_DP_LADY},
    {TRAINER_CLASS_BATTLE_GIRL, TRAINER_ENCOUNTER_MUSIC_DP_INTENSE},
    {TRAINER_CLASS_SWIMMER_F, TRAINER_ENCOUNTER_MUSIC_HG_GIRL_2},
    {TRAINER_CLASS_POKEFAN, TRAINER_ENCOUNTER_MUSIC_DP_TWINS},
    {TRAINER_CLASS_DRAGON_TAMER, TRAINER_ENCOUNTER_MUSIC_DP_INTENSE},
    {TRAINER_CLASS_COOLTRAINER, TRAINER_ENCOUNTER_MUSIC_DP_ACE_TRAINER},
    {TRAINER_CLASS_COOLTRAINER_2, TRAINER_ENCOUNTER_MUSIC_DP_ACE_TRAINER},
    {TRAINER_CLASS_GUITARIST, TRAINER_ENCOUNTER_MUSIC_DP_INTENSE},
    {TRAINER_CLASS_SAILOR, TRAINER_ENCOUNTER_MUSIC_DP_SAILOR},
    {TRAINER_CLASS_TWINS, TRAINER_ENCOUNTER_MUSIC_DP_TWINS},
    {TRAINER_CLASS_INTERVIEWER, TRAINER_ENCOUNTER_MUSIC_INTERVIEWER},
    {TRAINER_CLASS_RUIN_MANIAC, TRAINER_ENCOUNTER_MUSIC_DP_HIKER},
    {TRAINER_CLASS_GENTLEMAN, TRAINER_ENCOUNTER_MUSIC_DP_RICH},
    {TRAINER_CLASS_SWIMMER_M, TRAINER_ENCOUNTER_MUSIC_HG_BOY_2},
    {TRAINER_CLASS_POKEMANIAC, TRAINER_ENCOUNTER_MUSIC_HG_SUSPICIOUS_1},
    {TRAINER_CLASS_BLACK_BELT, TRAINER_ENCOUNTER_MUSIC_HG_BOY_2},
    {TRAINER_CLASS_OLD_COUPLE, TRAINER_ENCOUNTER_MUSIC_DP_RICH},
    {TRAINER_CLASS_BUG_MANIAC, TRAINER_ENCOUNTER_MUSIC_HG_SUSPICIOUS_1},
    {TRAINER_CLASS_CAMPER, TRAINER_ENCOUNTER_MUSIC_HG_BOY_1},
    {TRAINER_CLASS_KINDLER, TRAINER_ENCOUNTER_MUSIC_HG_BOY_2},
    ...
    {TRAINER_CLASS_LASS, TRAINER_ENCOUNTER_MUSIC_HG_GIRL_1},
    {TRAINER_CLASS_BUG_CATCHER, TRAINER_ENCOUNTER_MUSIC_HG_BOY_1},
    {TRAINER_CLASS_NINJA_BOY, TRAINER_ENCOUNTER_MUSIC_HG_SUSPICIOUS_1},
    {TRAINER_CLASS_RICH_BOY, TRAINER_ENCOUNTER_MUSIC_DP_RICH},
    {TRAINER_CLASS_HEX_MANIAC, TRAINER_ENCOUNTER_MUSIC_HG_SUSPICIOUS_1},
    {TRAINER_CLASS_BEAUTY, TRAINER_ENCOUNTER_MUSIC_HG_GIRL_2},
    {TRAINER_CLASS_LADY, TRAINER_ENCOUNTER_MUSIC_DP_LADY},
    {TRAINER_CLASS_PARASOL_LADY, TRAINER_ENCOUNTER_MUSIC_HG_GIRL_2},
    {TRAINER_CLASS_PICNICKER, TRAINER_ENCOUNTER_MUSIC_HG_GIRL_1},
    {TRAINER_CLASS_PKMN_BREEDER, TRAINER_ENCOUNTER_MUSIC_DP_LADY},
    {TRAINER_CLASS_COLLECTOR, TRAINER_ENCOUNTER_MUSIC_HG_SUSPICIOUS_2},
    {TRAINER_CLASS_PKMN_RANGER, TRAINER_ENCOUNTER_MUSIC_DP_ACE_TRAINER},
    {TRAINER_CLASS_RIVAL, TRAINER_ENCOUNTER_MUSIC_DP_BOY},
    {TRAINER_CLASS_YOUNG_COUPLE, TRAINER_ENCOUNTER_MUSIC_DP_TWINS},
    {TRAINER_CLASS_PSYCHIC, TRAINER_ENCOUNTER_MUSIC_DP_INTENSE},
    {TRAINER_CLASS_SR_AND_JR, TRAINER_ENCOUNTER_MUSIC_DP_TWINS},
    {TRAINER_CLASS_ELITE_FOUR, TRAINER_ENCOUNTER_MUSIC_DP_ELITE_FOUR},
    {TRAINER_CLASS_YOUNGSTER, TRAINER_ENCOUNTER_MUSIC_HG_BOY_1},
    {TRAINER_CLASS_EXPERT, TRAINER_ENCOUNTER_MUSIC_DP_INTENSE},
    {TRAINER_CLASS_TRIATHLETE, TRAINER_ENCOUNTER_MUSIC_DP_CYCLIST},
    {TRAINER_CLASS_BIRD_KEEPER, TRAINER_ENCOUNTER_MUSIC_DP_ACE_TRAINER},
    {TRAINER_CLASS_FISHERMAN, TRAINER_ENCOUNTER_MUSIC_HG_BOY_2},
    {TRAINER_CLASS_CHAMPION, TRAINER_ENCOUNTER_MUSIC_DP_CHAMPION},
    {TRAINER_CLASS_TUBER_M, TRAINER_ENCOUNTER_MUSIC_HG_BOY_1},
    {TRAINER_CLASS_TUBER_F, TRAINER_ENCOUNTER_MUSIC_HG_GIRL_1},
    {TRAINER_CLASS_SIS_AND_BRO, TRAINER_ENCOUNTER_MUSIC_DP_TWINS},
    {TRAINER_CLASS_HIKER, TRAINER_ENCOUNTER_MUSIC_DP_HIKER},
    {TRAINER_CLASS_LEADER, TRAINER_ENCOUNTER_MUSIC_DP_INTENSE},
    {TRAINER_CLASS_SCHOOL_KID, TRAINER_ENCOUNTER_MUSIC_HG_BOY_1},
    {TRAINER_CLASS_POLICEMAN, TRAINER_ENCOUNTER_MUSIC_HG_BOY_2},
    {TRAINER_CLASS_SUPER_NERD, TRAINER_ENCOUNTER_MUSIC_HG_SUSPICIOUS_1},
    {TRAINER_CLASS_TEAM_ROCKET, TRAINER_ENCOUNTER_MUSIC_ROCKET},
    {TRAINER_CLASS_ROCKET_ADMIN, TRAINER_ENCOUNTER_MUSIC_ROCKET},
    {TRAINER_CLASS_SAGE, TRAINER_ENCOUNTER_MUSIC_HG_SAGE},
    {TRAINER_CLASS_ENGINEER, TRAINER_ENCOUNTER_MUSIC_HG_BOY_2},
    {TRAINER_CLASS_FIREBREATHER, TRAINER_ENCOUNTER_MUSIC_HG_BOY_2},
    {TRAINER_CLASS_KIMONO_GIRL, TRAINER_ENCOUNTER_MUSIC_HG_KIMONO_GIRL},
    {TRAINER_CLASS_BIKER, TRAINER_ENCOUNTER_MUSIC_DP_CYCLIST},
    {TRAINER_CLASS_MYSTERY_MAN, TRAINER_ENCOUNTER_MUSIC_HG_SUSPICIOUS_2},
    {TRAINER_CLASS_BURGLAR, TRAINER_ENCOUNTER_MUSIC_HG_SUSPICIOUS_2},
    {TRAINER_CLASS_JUGGLER, TRAINER_ENCOUNTER_MUSIC_HG_SUSPICIOUS_1},
    {TRAINER_CLASS_PSYCHIC_M, TRAINER_ENCOUNTER_MUSIC_HG_BOY_1},
    {TRAINER_CLASS_PHILIP, TRAINER_ENCOUNTER_MUSIC_HG_BOY_2},
    {TRAINER_CLASS_ROCKETA, TRAINER_ENCOUNTER_MUSIC_ROCKET},
};
...
{
    CopyFrontierTrainerText(FRONTIER_PLAYER_LOST_TEXT, trainerId);
}

void CopyPyramidTrainerLoseSpeech(u16 trainerId)
{
    CopyFrontierTrainerText(FRONTIER_PLAYER_WON_TEXT, trainerId);
}
