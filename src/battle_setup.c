...
{
    [REMATCH_ROSE] = REMATCH(TRAINER_GRUNT_33, TRAINER_ROSE_2, TRAINER_ROSE_3, TRAINER_ROSE_4, TRAINER_ROSE_4, MAP_ROUTE118),
    [REMATCH_ANDRES] = REMATCH(TRAINER_BRIANA, TRAINER_BROOKE, TRAINER_BURT, TRAINER_CALVIN, TRAINER_CAMERON, MAP_ROUTE118),
    [REMATCH_DUSTY] = REMATCH(TRAINER_KRISE, TRAINER_KUNI, TRAINER_KYLE, TRAINER_LAO, TRAINER_LEA_AND_PIA, MAP_ROUTE118),
    [REMATCH_LOLA] = REMATCH(TRAINER_LOLA_1, TRAINER_LOLA_1, TRAINER_LOLA_1, TRAINER_LOLA_1, TRAINER_LOLA_1, MAP_ROUTE118),
    [REMATCH_RICKY] = REMATCH(TRAINER_RICKY_1, TRAINER_RICKY_2, TRAINER_RICKY_3, TRAINER_RICKY_4, TRAINER_RICKY_5, MAP_ROUTE118),
    [REMATCH_LILA_AND_ROY] = REMATCH(TRAINER_LILA_AND_ROY_1, TRAINER_LILA_AND_ROY_2, TRAINER_LILA_AND_ROY_3, TRAINER_LILA_AND_ROY_4, TRAINER_LILA_AND_ROY_5, MAP_ROUTE118),
    [REMATCH_CRISTIN] = REMATCH(TRAINER_HILLARY, TRAINER_HORTON, TRAINER_IAN, TRAINER_IRWIN, TRAINER_ISSAC, MAP_ROUTE118),
    [REMATCH_BROOKE] = REMATCH(TRAINER_EMMA, TRAINER_ERICK, TRAINER_ERIK, TRAINER_ERIN, TRAINER_ERNEST, MAP_ROUTE118),
    [REMATCH_WILTON] = REMATCH(TRAINER_WILTON_1, TRAINER_WILTON_2, TRAINER_WILTON_3, TRAINER_WILTON_4, TRAINER_WILTON_5, MAP_ROUTE118),
    [REMATCH_VALERIE] = REMATCH(TRAINER_VALERIE_1, TRAINER_VALERIE_1, TRAINER_VALERIE_1, TRAINER_VALERIE_1, TRAINER_VALERIE_1, MAP_ROUTE118),
    [REMATCH_CINDY] = REMATCH(TRAINER_GRUNT_18, TRAINER_GRUNT_20, TRAINER_GRUNT_21, TRAINER_GRUNT_22, TRAINER_GRUNT_23, MAP_ROUTE118),
    [REMATCH_THALIA] = REMATCH(TRAINER_THALIA_1, TRAINER_THALIA_2, TRAINER_THALIA_3, TRAINER_THALIA_4, TRAINER_THALIA_5, MAP_ROUTE118),
    [REMATCH_JESSICA] = REMATCH(TRAINER_ARIANA_1, TRAINER_ARIANA_2, TRAINER_JESSICA_3, TRAINER_JESSICA_4, TRAINER_JESSICA_5, MAP_ROUTE118),
    [REMATCH_WINSTON] = REMATCH(TRAINER_WINSTON_1, TRAINER_WINSTON_1, TRAINER_WINSTON_1, TRAINER_WINSTON_1, TRAINER_WINSTON_1, MAP_ROUTE118),
    [REMATCH_STEVE] = REMATCH(TRAINER_STEVE_1, TRAINER_STEVE_2, TRAINER_STEVE_3, TRAINER_STEVE_4, TRAINER_STEVE_5, MAP_ROUTE114),
    [REMATCH_TONY] = REMATCH(TRAINER_TONY_1, TRAINER_TONY_2, TRAINER_TONY_3, TRAINER_TONY_4, TRAINER_TONY_5, MAP_ROUTE118),
    ...
    [REMATCH_FERNANDO] = REMATCH(TRAINER_NORTON, TRAINER_OTIS, TRAINER_PARRY, TRAINER_PATON, TRAINER_PETER, MAP_ROUTE123),
    [REMATCH_DALTON] = REMATCH(TRAINER_JENN, TRAINER_JEREMY, TRAINER_JERRY, TRAINER_JESSICA, TRAINER_JILL, MAP_ROUTE118),
    [REMATCH_BERNIE] = REMATCH(TRAINER_DARYL, TRAINER_DAVE, TRAINER_DAWN, TRAINER_DENIS, TRAINER_DIANA, MAP_ROUTE114),
    [REMATCH_ETHAN] = REMATCH(TRAINER_NAOKO, TRAINER_NATHAN, TRAINER_NEAL, TRAINER_NICK, TRAINER_NICO, MAP_ROUTE118),
    [REMATCH_JOHN_AND_JAY] = REMATCH(TRAINER_JOHN_AND_JAY_1, TRAINER_JOHN_AND_JAY_2, TRAINER_JOHN_AND_JAY_3, TRAINER_JOHN_AND_JAY_4, TRAINER_JOHN_AND_JAY_5, MAP_ROUTE118),
    [REMATCH_JEFFREY] = REMATCH(TRAINER_RIVAL_TOTODILE_5, TRAINER_RIVAL_TOTODILE_6, TRAINER_RIVAL_TOTODILE_7, TRAINER_RED_1, TRAINER_RED_2, MAP_ROUTE120),
    [REMATCH_CAMERON] = REMATCH(TRAINER_GAVEN, TRAINER_GINA, TRAINER_GLENN, TRAINER_GORDON, TRAINER_GREGG, MAP_ROUTE123),
    [REMATCH_JACKI] = REMATCH(TRAINER_LANCE_1, TRAINER_LANCE_2, TRAINER_RIVAL_CHIKORITA_1, TRAINER_RIVAL_CHIKORITA_2, TRAINER_RIVAL_CHIKORITA_3, MAP_ROUTE123),
    ...
    [REMATCH_JERRY] = REMATCH(TRAINER_ARCHER_1, TRAINER_ARCHER_4, TRAINER_ARCHER_5, TRAINER_ARCHER_5, TRAINER_ARCHER_5, MAP_ROUTE116),
    ...
    [REMATCH_ISABEL] = REMATCH(TRAINER_LTSURGE, TRAINER_ERIKA, TRAINER_SABRINA, TRAINER_JANINE, TRAINER_BLAINE, MAP_ROUTE118),
    [REMATCH_MIGUEL] = REMATCH(TRAINER_MIGUEL_1, TRAINER_MIGUEL_2, TRAINER_MIGUEL_3, TRAINER_MIGUEL_4, TRAINER_MIGUEL_5, MAP_ROUTE118),
    [REMATCH_TIMOTHY] = REMATCH(TRAINER_TIMOTHY_1, TRAINER_TIMOTHY_1, TRAINER_TIMOTHY_1, TRAINER_TIMOTHY_1, TRAINER_TIMOTHY_1, MAP_ROUTE115),
    [REMATCH_SHELBY] = REMATCH(TRAINER_SHELBY_1, TRAINER_SHELBY_2, TRAINER_SHELBY_3, TRAINER_SHELBY_4, TRAINER_SHELBY_5, MAP_ROUTE112),
    [REMATCH_CALVIN] = REMATCH(TRAINER_EUGENE, TRAINER_FIDEL, TRAINER_FRAN, TRAINER_FRITZ, TRAINER_GAKU, MAP_ROUTE112),
    [REMATCH_ELLIOT] = REMATCH(TRAINER_MASA, TRAINER_MATHEW, TRAINER_MEG_AND_PEG, TRAINER_MEGAN, TRAINER_MICHAEL,  MAP_ROUTE116),
    [REMATCH_ISAIAH] = REMATCH(TRAINER_WILL_2, TRAINER_BRUNO_1, TRAINER_BRUNO_2, TRAINER_KAREN_1, TRAINER_KAREN_2, MAP_ROUTE128),
    [REMATCH_MARIA] = REMATCH(TRAINER_MARIA_1, TRAINER_MARIA_2, TRAINER_MARIA_3, TRAINER_MARIA_4, TRAINER_MARIA_5, MAP_ROUTE117),
    [REMATCH_ABIGAIL] = REMATCH(TRAINER_ABE, TRAINER_AL, TRAINER_ALFRED, TRAINER_ALLAN, TRAINER_ANDRE, MAP_ROUTE110),
    [REMATCH_DYLAN] = REMATCH(TRAINER_LEWIS, TRAINER_LI, TRAINER_LISA, TRAINER_LIZ, TRAINER_LLOYD, MAP_ROUTE117),
    ...
    [REMATCH_NICOLAS] = REMATCH(TRAINER_NICOLAS_1, TRAINER_NICOLAS_2, TRAINER_NICOLAS_3, TRAINER_NICOLAS_4, TRAINER_NICOLAS_5, MAP_ROUTE112),
    ...
    [REMATCH_CYNDY] = REMATCH(TRAINER_JAMIE, TRAINER_JAKE, TRAINER_JAMES, TRAINER_JASON, TRAINER_JAY, MAP_ROUTE115),
    ...
    [REMATCH_JENNY] = REMATCH(TRAINER_PROTON_1, TRAINER_PROTON_2, TRAINER_ARCHER_5, TRAINER_PETREL_1, TRAINER_ARCHER, MAP_ROUTE124),
    [REMATCH_DIANA] = REMATCH(TRAINER_KAZU, TRAINER_KEITH, TRAINER_KELLY, TRAINER_KEN, TRAINER_KEANDRA, MAP_ROUTE118),
    [REMATCH_AMY_AND_LIV] = REMATCH(TRAINER_AMY_AND_MAY, TRAINER_ANN_AND_ANNE, TRAINER_AMY_AND_LIV_4, TRAINER_AMY_AND_LIV_5, TRAINER_AMY_AND_LIV_6,  MAP_ROUTE113),
    [REMATCH_ERNEST] = REMATCH(TRAINER_MIKE, TRAINER_MIKEY, TRAINER_MIKI, TRAINER_MILLER, TRAINER_MITCH, MAP_ROUTE125),
    [REMATCH_CORY] = REMATCH(TRAINER_GRUNT_29, TRAINER_HAL, TRAINER_HANK, TRAINER_HAROLD, TRAINER_HARRIS,  MAP_ROUTE118),
    [REMATCH_EDWIN] = REMATCH(TRAINER_LOLA, TRAINER_LORI, TRAINER_MARGRET, TRAINER_MARKUS, TRAINER_MARTIN, MAP_ROUTE110),
    [REMATCH_LYDIA] = REMATCH(TRAINER_LYDIA_1, TRAINER_LYDIA_2, TRAINER_LYDIA_3, TRAINER_LYDIA_4, TRAINER_LYDIA_5, MAP_ROUTE117),
    [REMATCH_ISAAC] = REMATCH(TRAINER_CHUCK_1_3, TRAINER_CLAIR_1, TRAINER_CLAIR_2, TRAINER_BROCK, TRAINER_MISTY, MAP_ROUTE117),
    [REMATCH_GABRIELLE] = REMATCH(TRAINER_ROD, TRAINER_RON, TRAINER_ROSS, TRAINER_ROXANNE, TRAINER_ROY, MAP_ROUTE118),
    [REMATCH_CATHERINE] = REMATCH(TRAINER_GRUNT_3, TRAINER_GRUNT_4, TRAINER_GRUNT_5, TRAINER_GRUNT_6, TRAINER_GRUNT_7, MAP_ROUTE119),
    [REMATCH_JACKSON] = REMATCH(TRAINER_RIVAL_CHIKORITA_4, TRAINER_RIVAL_CHIKORITA_5, TRAINER_RIVAL_CHIKORITA_6, TRAINER_RIVAL_CHIKORITA_7, TRAINER_RIVAL_CYNDAQUIL_1, MAP_ROUTE119),
    [REMATCH_HALEY] = REMATCH(TRAINER_WHITNEY_1, TRAINER_WHITNEY_2, TRAINER_MORTY_1, TRAINER_MORTY_2, TRAINER_PRYCE_1, MAP_ROUTE118),
    [REMATCH_JAMES] = REMATCH(TRAINER_RIVAL_CYNDAQUIL_4, TRAINER_RIVAL_CYNDAQUIL_5, TRAINER_RIVAL_CYNDAQUIL_6, TRAINER_RIVAL_CYNDAQUIL_7, TRAINER_RIVAL_TOTODILE_1, MAP_ROUTE118),
    [REMATCH_TRENT] = REMATCH(TRAINER_TRENT_1, TRAINER_TRENT_2, TRAINER_TRENT_3, TRAINER_TRENT_4, TRAINER_TRENT_5, MAP_ROUTE112),
    [REMATCH_SAWYER] = REMATCH(TRAINER_SAWYER_1, TRAINER_SAWYER_2, TRAINER_SAWYER_3, TRAINER_SAWYER_4, TRAINER_SAWYER_5, MAP_ROUTE112),
    [REMATCH_KIRA_AND_DAN] = REMATCH(TRAINER_KIRA_AND_DAN_1, TRAINER_KIRA_AND_DAN_2, TRAINER_KIRA_AND_DAN_3, TRAINER_KIRA_AND_DAN_4, TRAINER_KIRA_AND_DAN_5, MAP_ROUTE118),
    [REMATCH_WALLY_VR] = REMATCH(TRAINER_WALLY_VR_2, TRAINER_WALLY_VR_3, TRAINER_WALLY_VR_4, TRAINER_WALLY_VR_5, TRAINER_WALLY_VR_5, MAP_ROUTE118),
    [REMATCH_ROXANNE] = REMATCH(TRAINER_ROXANNE_1, TRAINER_ROXANNE_2, TRAINER_ROXANNE_3, TRAINER_ROXANNE_4, TRAINER_ROXANNE_5, MAP_ROUTE118),
    [REMATCH_BRAWLY] = REMATCH(TRAINER_DICK, TRAINER_DIRK, TRAINER_DON, TRAINER_DORIS, TRAINER_EDNA, MAP_ROUTE118),
    [REMATCH_WATTSON] = REMATCH(TRAINER_WATTSON_1, TRAINER_WATTSON_4, TRAINER_WATTSON_4, TRAINER_WATTSON_4, TRAINER_WATTSON_5, MAP_ROUTE118),
    [REMATCH_FLANNERY] = REMATCH(TRAINER_PING, TRAINER_QUENTIN, TRAINER_QUINN, TRAINER_RACHAEL, TRAINER_RALPH, MAP_ROUTE118),
    [REMATCH_NORMAN] = REMATCH(TRAINER_NORMAN_1, TRAINER_NORMAN_2, TRAINER_NORMAN_3, TRAINER_NORMAN_4, TRAINER_NORMAN_5, MAP_ROUTE118),
    [REMATCH_WINONA] = REMATCH(TRAINER_WINONA_1, TRAINER_WINONA_2, TRAINER_WINONA_3, TRAINER_WINONA_4, TRAINER_WINONA_5, MAP_ROUTE118),
    [REMATCH_TATE_AND_LIZA] = REMATCH(TRAINER_TATE_AND_LIZA_1, TRAINER_TATE_AND_LIZA_2, TRAINER_TATE_AND_LIZA_3, TRAINER_TATE_AND_LIZA_4, TRAINER_TATE_AND_LIZA_5, MAP_ROUTE118),
    [REMATCH_JUAN] = REMATCH(TRAINER_JUAN_1, TRAINER_JUAN_2, TRAINER_JUAN_3, TRAINER_JUAN_4, TRAINER_JUAN_5, MAP_ROUTE112),
    [REMATCH_SIDNEY] = REMATCH(TRAINER_SIDNEY, TRAINER_SIDNEY, TRAINER_SIDNEY, TRAINER_SIDNEY, TRAINER_SIDNEY, MAP_ROUTE118),
    [REMATCH_PHOEBE] = REMATCH(TRAINER_PHOEBE, TRAINER_PHOEBE, TRAINER_PHOEBE, TRAINER_PHOEBE, TRAINER_PHOEBE, MAP_ROUTE118),
    [REMATCH_GLACIA] = REMATCH(TRAINER_GLACIA, TRAINER_GLACIA, TRAINER_GLACIA, TRAINER_GLACIA, TRAINER_GLACIA, MAP_ROUTE118),
    [REMATCH_DRAKE] = REMATCH(TRAINER_KIP, TRAINER_KIP, TRAINER_KIP, TRAINER_KIP, TRAINER_KIP, MAP_ROUTE118),
    [REMATCH_WALLACE] = REMATCH(TRAINER_WALLACE, TRAINER_WALLACE, TRAINER_WALLACE, TRAINER_WALLACE, TRAINER_WALLACE, MAP_ROUTE118),
};
