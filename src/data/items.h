...
#define POWER_ITEM_BOOST ((I_POWER_ITEM_BOOST >= GEN_7) ? 32 : 4)
...
static const u8 sMuscleFeatherDesc[]  = _("An item that raises\n"
                                          "the Innate Attack\n"
                                          "value of a Pokémon.");
static const u8 sMuscleMochiDesc[]    = _("An item that raises\n"
                                          "the base Attack of\n"
                                          "a Pokémon.");
...
static const u8 sResistFeatherDesc[]  = _("An item that raises\n"
                                          "the Innate Defense\n"
                                          "value of a Pokémon.");
static const u8 sResistMochiDesc[]    = _("An item that raises\n"
                                          "the base Defense\n"
                                          "of a Pokémon.");
...
static const u8 sGeniusFeatherDesc[]  = _("An item that raises\n"
                                          "the Innate Sp. Atk\n"
                                          "value of a Pokémon.");
static const u8 sGeniusMochiDesc[]    = _("An item that raises\n"
                                          "the base Sp. Atk.\n"
                                          "of a Pokémon.");
...
static const u8 sCleverFeatherDesc[]  = _("An item that raises\n"
                                          "the Innate Sp. Def\n"
                                          "value of a Pokémon.");
static const u8 sCleverMochiDesc[]    = _("An item that raises\n"
                                          "the base Sp. Def.\n"
                                          "of a Pokémon.");
...
static const u8 sSwiftFeatherDesc[]   = _("An item that raises\n"
                                          "the Innate Speed\n"
                                          "value of a Pokémon.");
static const u8 sSwiftMochiDesc[]     = _("An item that raises\n"
                                          "the base Speed of\n"
                                          "a Pokémon.");
...
// Poké Balls
    ...
    [ITEM_SPORT_BALL] =
    {
        ...
        .price = (I_PRICE <= GEN_3 || I_PRICE >= GEN_9) ? 150 : 300,
        .description = COMPOUND_STRING(
            "A special Ball\n"
            "used in the Bug-\n"
            "Catching Contest."),
...
// TMs/HMs. They don't have a set flingPower, as that's handled by GetFlingPowerFromItemId.
    ...
    [ITEM_TM_SMACK_DOWN] =
    {
        .name = ITEM_NAME("TM23 Smack Down"),
        .price = 3000,
        .description = COMPOUND_STRING(
            "Slams the foe with\n"
            "a rock. It will\n"
    ...
    [ITEM_TM_LEECH_LIFE] =
    {
        .name = ITEM_NAME("TM28 Leech Life"),
        .price = 2000,
        .description = COMPOUND_STRING(
            "Drains the foe and\n"
            "restores half the\n"
    ...
    [ITEM_TM_SLUDGE_WAVE] =
    {
        .name = ITEM_NAME("TM34 Sludge Wave"),
        .price = 3000,
        .description = COMPOUND_STRING(
            "Hits all around\n"
            "with sludge. May\n"
    ...
    {
        .name = ITEM_NAME("TM43 Flame Charge"),
        .price = 3000,
        .description = COMPOUND_STRING(
            "Surround the user\n"
            "with flames to ram\n"
    ...
    {
        .name = ITEM_NAME("TM49 Echoed Voice"),
        .price = 3000,
        .description = COMPOUND_STRING(
            "An echoing voice.\n"
            "Repeated uses\n"
    ...
    [ITEM_TM_STEEL_WING] =
    {
        .name = ITEM_NAME("TM51 Steel Wing"),
        .price = 3000,
        .description = COMPOUND_STRING(
            "Hits with steel\n"
            "wings. May raise\n"
    ...
    [ITEM_TM_FOCUS_BLAST] =
    {
        .name = ITEM_NAME("TM52 Focus Blast"),
        .price = 3000,
        .description = COMPOUND_STRING(
            "A focused blast.\n"
            "May lower the\n"
    ...
    [ITEM_TM_ENERGY_BALL] =
    {
        .name = ITEM_NAME("TM53 Energy Ball"),
        .price = 3000,
        .description = COMPOUND_STRING(
            "Draws power from\n"
            "nature to attack.\n"
    ...
    [ITEM_TM_FALSE_SWIPE] =
    {
        .name = ITEM_NAME("TM54 False Swipe"),
        .price = 3000,
        .description = COMPOUND_STRING(
            "A restrained hit\n"
            "that leaves the\n"
    ...
    [ITEM_TM_CHARGE_BEAM] =
    {
        .name = ITEM_NAME("TM57 Charge Beam"),
        .price = 3000,
        .description = COMPOUND_STRING(
            "Attacks with an\n"
            "electric charge.\n"
    ...
    {
        .name = ITEM_NAME("TM59 Brutal Swing"),
        .price = 3000,
        .description = COMPOUND_STRING(
            "Swings around to\n"
            "damage everything\n"
    ...
    [ITEM_TM_TRAILBLAZE] =
    {
        .name = ITEM_NAME("TM60 Trailblaze"),
        .price = 3000,
        .description = COMPOUND_STRING(
            "Attack's suddenly\n"
            "and boosts user's\n"
    ...
    [ITEM_TM_WILL_O_WISP] =
    {
        .name = ITEM_NAME("TM61 Will-o-Wisp"),
        .price = 3000,
        .description = COMPOUND_STRING(
    "Shoots a bluish-\n"
    "white flame to burn\n"
    ...
    [ITEM_TM_ACROBATICS] =
    {
        .name = ITEM_NAME("TM62 Acrobatics"),
        .price = 3000,
        .description = COMPOUND_STRING(
            "Hits harder if\n"
            "the user holds\n"
    ...
    {
        .name = ITEM_NAME("TM63 Thunder Punch"),
        .price = 5000,
        .description = COMPOUND_STRING(
            "An electric punch.\n"
            "May paralyze."),
    ...
    [ITEM_TM_SHADOW_CLAW] =
    {
        .name = ITEM_NAME("TM65 Shadow Claw"),
        .price = 3000,
        .description = COMPOUND_STRING(
    "Slashes with claws\n"
    "of shadows. High\n"
    ...
    {
        .name = ITEM_NAME("TM67 Smart Strike"),
        .price = 3000,
        .description = COMPOUND_STRING(
            "Stabs with a sharp\n"
            "horn. This attack\n"
    ...
    [ITEM_TM_GIGA_IMPACT] =
    {
        .name = ITEM_NAME("TM68 Giga Impact"),
        .price = 3000,
        .description = COMPOUND_STRING(
    "The user charges\n"
    "with all its power.\n"
    ...
    [ITEM_TM_FIRE_PUNCH] =
    {
        .name = ITEM_NAME("TM69 Fire Punch"),
        .price = 5000,
        .description = COMPOUND_STRING(
            "A fiery punch\n"
            "that may burn the\n"
    ...
    [ITEM_TM_AURORA_VEIL] =
    {
        .name = ITEM_NAME("TM70 Aurora Veil"),
        .price = 3000,
        .description = COMPOUND_STRING(
            "Weakens physical\n"
            "and special hits\n"
    ...
    [ITEM_TM_STONE_EDGE] =
    {
        .name = ITEM_NAME("TM71 Stone Edge"),
        .price = 3000,
        .description = COMPOUND_STRING(
    "Stabs the foe with\n"
    "sharp stones. High\n"
    ...
    [ITEM_TM_VOLT_SWITCH] =
    {
        .name = ITEM_NAME("TM72 Volt Switch"),
        .price = 3000,
        .description = COMPOUND_STRING(
    "Attacks and rushes\n"
    "back to switch with\n"
    ...
    {
        .name = ITEM_NAME("TM73 Thunder Wave"),
        .price = 3000,
        .description = COMPOUND_STRING(
    "A weak electric\n"
    "charge that causes\n"
    ...
    [ITEM_TM_HONE_CLAWS] =
    {
        .name = ITEM_NAME("TM76 Hone Claws"),
        .price = 3000,
        .description = COMPOUND_STRING(
            "Sharpens claws to\n"
            "raise Attack and\n"
    ...
    {
        .name = ITEM_NAME("TM79 Frost Breath"),
        .price = 3000,
        .description = COMPOUND_STRING(
    "Blows a cold breath\n"
    "on the foe. Always\n"
    ...
    [ITEM_TM_ROCK_SLIDE] =
    {
        .name = ITEM_NAME("TM80 Rock Slide"),
        .price = 3000,
        .description = COMPOUND_STRING(
            "Hurls boulders\n"
            "at foes. May\n"
    ...
    [ITEM_TM_DRAGON_TAIL] =
    {
        .name = ITEM_NAME("TM82 Dragon Tail"),
        .price = 3000,
        .description = COMPOUND_STRING(
    "Knocks away foe\n"
    "and drags out\n"
    ...
    [ITEM_TM_INFESTATION] =
    {
        .name = ITEM_NAME("TM83 Infestation"),
        .price = 3000,
        .description = COMPOUND_STRING(
    "The foe is infested\n"
    "and attacked for\n"
    ...
    [ITEM_TM_POISON_JAB] =
    {
        .name = ITEM_NAME("TM84 Poison Jab"),
        .price = 3000,
        .description = COMPOUND_STRING(
            "Jabs the foe with\n"
            "poison. May also\n"
    ...
    [ITEM_TM_GRASS_KNOT] =
    {
        .name = ITEM_NAME("TM86 Grass Knot"),
        .price = 3000,
        .description = COMPOUND_STRING(
            "Trips the foe.\n"
            "Heavier foes take\n"
    ...
    [ITEM_TM_SUBSTITUTE] =
    {
        .name = ITEM_NAME("TM90 Substitute"),
        .price = 3000,
        .description = COMPOUND_STRING(
    "The user cuts some\n"
    "HP to create a copy\n"
    ...
    {
        .name = ITEM_NAME("TM91 Flash Cannon"),
        .price = 3000,
        .description = COMPOUND_STRING(
    "Releases light\n"
    "energy at the foe\n"
    ...
    [ITEM_TM_TRICK_ROOM] =
    {
        .name = ITEM_NAME("TM92 Trick Room"),
        .price = 3000,
        .description = COMPOUND_STRING(
    "Causes slower\n"
    "Pokémon to move\n"
    ...
    [ITEM_TM_WILD_CHARGE] =
    {
        .name = ITEM_NAME("TM93 Wild Charge"),
        .price = 3000,
        .description = COMPOUND_STRING(
    "An electric charge\n"
    "smashes the foe,\n"
    ...
    [ITEM_TM_ICE_SPINNER] =
    {
        .name = ITEM_NAME("TM94 Ice Spinner"),
        .price = 3000,
        .description = COMPOUND_STRING(
            "Covers its feet in\n"
            "ice and spins into\n"
    ...
    {
        .name = ITEM_NAME("TM96 Nature Power"),
        .price = 3000,
        .description = COMPOUND_STRING(
    "The effects vary\n"
    "depending on the\n"
    ...
    [ITEM_TM_DARK_PULSE] =
    {
        .name = ITEM_NAME("TM97 Dark Pulse"),
        .price = 3000,
        .description = COMPOUND_STRING(
    "Releases a horrible\n"
    "aura. May also make\n"
    ...
    {
        .name = ITEM_NAME("TM99 Dazzling Gleam"),
        .price = 3000,
        .description = COMPOUND_STRING(
    "A powerful fairy\n"
    "attack damaging\n"
    ...
    [ITEM_HM_ROCK_CLIMB] =
    {
        .name = ITEM_NAME("HM09 Rock Climb"),
        .price = 0,
        .description = COMPOUND_STRING(
            "A charging attack\n"
            "that may confuse\n"
...
// GEN 9 ITEMS
    ...
    {
        .name = ITEM_NAME("Darkness Scroll"),
