...
#define GENGAR_SP_DEF (P_UPDATED_STATS >= GEN_2 ? 75 : 130)
    ...
    [SPECIES_ONIX] =
    {
        ...
        .innates = { ABILITY_STONE_FACE, ABILITY_BURROWER },
		.bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Onix"),
        .cryId = CRY_ONIX,
    ...
    [SPECIES_TAUROS_PALDEA_BLAZE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_ANGER_POINT, ABILITY_CUD_CHEW },
        .innates = { ABILITY_FLAME_BODY, ABILITY_VITAL_SPIRIT, ABILITY_UNSTOPPABLE },
		.bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Tauros"),
        .cryId = CRY_TAUROS,
        .natDexNum = NATIONAL_DEX_TAUROS,
    ...
    [SPECIES_GYARADOS] =
    {
        ...
        .innates = { ABILITY_ANGER_POINT, ABILITY_STRONG_JAW, ABILITY_DRAGON_SOUL },
		.bodyColor = BODY_COLOR_BLUE,
