...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_CHIKORITA] =
    {
        ...
        .iconPalIndex = 1,
        .iconPalette = gMonIconPalette_Chikorita,
        .shinyIconPalette = gMonShinyIconPalette_Chikorita,
    ...
    [SPECIES_BAYLEEF] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_GRASS),
        .abilities = { ABILITY_OVERGROW, ABILITY_NONE, ABILITY_LEAF_GUARD },
        .innates = { ABILITY_NATURAL_CURE, ABILITY_FLOWER_VEIL },
        .bodyColor = BODY_COLOR_GREEN,
        ...
        .iconPalIndex = 1,
        .iconPalette = gMonIconPalette_Bayleef,
        .shinyIconPalette = gMonShinyIconPalette_Bayleef,
    ...
    [SPECIES_MEGANIUM] =
    {
        ...
        .iconPalIndex = 1,
        .iconPalette = gMonIconPalette_Meganium,
        .shinyIconPalette = gMonShinyIconPalette_Meganium,
    ...
    [SPECIES_CYNDAQUIL] =
    {
        ...
        .iconPalette = gMonIconPalette_Cyndaquil,
        .shinyIconPalette = gMonShinyIconPalette_Cyndaquil,
    ...
    [SPECIES_QUILAVA] =
    {
        ...
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 1 : 3,
        .iconPalette = gMonIconPalette_Quilava,
        .shinyIconPalette = gMonShinyIconPalette_Quilava,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_TYPHLOSION] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BLAZE, ABILITY_NONE, ABILITY_FLASH_FIRE },
        .innates = { ABILITY_FLAME_BODY, ABILITY_BERSERK, ABILITY_FLAME_RUSH },
        .bodyColor = BODY_COLOR_YELLOW,
        ...
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 1 : 3,
        .iconPalette = gMonIconPalette_Typhlosion,
        .shinyIconPalette = gMonShinyIconPalette_Typhlosion,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_TYPHLOSION_MEGA] =
    {
        ...
        .innates = { ABILITY_SOLAR_POWER, ABILITY_FLAME_BODY, ABILITY_FLAME_RUSH },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Typhlosion"),
        .cryId = CRY_TYPHLOSION,
        .natDexNum = NATIONAL_DEX_TYPHLOSION,
        ...
        .weight = 895,
        .description = COMPOUND_STRING(
            "Mega Evolution turns the air around it\n"
            "into a wavering inferno. Its explosive\n"
            "blasts can scour a battlefield clean in\n"
            "a single roaring flash."),
        ...
        .iconPalette = gMonIconPalette_TyphlosionMega,
        .shinyIconPalette = gMonShinyIconPalette_TyphlosionMega,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 1 : 3,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        FOOTPRINT(Typhlosion)
        SHADOW(4, 14, SHADOW_SIZE_L)
    ...
    [SPECIES_TYPHLOSION_HISUI] =
    {
        ...
        .innates = { ABILITY_INFERNAL, ABILITY_CURSED_BODY, ABILITY_SOUL_HEART },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Typhlosion"),
        .cryId = CRY_TYPHLOSION,
        .natDexNum = NATIONAL_DEX_TYPHLOSION,
    ...
    [SPECIES_TOTODILE] =
    {
        ...
        .iconPalette = gMonIconPalette_Totodile,
        .shinyIconPalette = gMonShinyIconPalette_Totodile,
    ...
    [SPECIES_CROCONAW] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_TORRENT, ABILITY_NONE, ABILITY_SHEER_FORCE },
        .innates = { ABILITY_STRONG_JAW, ABILITY_INTIMIDATE },
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
        ...
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 2 : 0,
        .iconPalette = gMonIconPalette_Croconaw,
        .shinyIconPalette = gMonShinyIconPalette_Croconaw,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_FERALIGATR] =
    {
        ...
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 2 : 0,
        .iconPalette = gMonIconPalette_Feraligatr,
        .shinyIconPalette = gMonShinyIconPalette_Feraligatr,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_SENTRET] =
    {
        ...
        .iconPalIndex = 2,
        .iconPalette = gMonIconPalette_Sentret,
        .shinyIconPalette = gMonShinyIconPalette_Sentret,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_FURRET] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_RUN_AWAY, ABILITY_KEEN_EYE, ABILITY_FRISK },
        .innates = { ABILITY_QUICK_FEET, ABILITY_STAKEOUT, ABILITY_SCRAPPY },
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .iconPalIndex = 2,
        .iconPalette = gMonIconPalette_Furret,
        .shinyIconPalette = gMonShinyIconPalette_Furret,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_HOOTHOOT] =
    {
        ...
        .iconPalIndex = 2,
        .iconPalette = gMonIconPalette_Hoothoot,
        .shinyIconPalette = gMonShinyIconPalette_Hoothoot,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_NOCTOWL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_INSOMNIA, ABILITY_KEEN_EYE, ABILITY_TINTED_LENS },
        .innates = { ABILITY_SOOTHING, ABILITY_WONDER_SKIN, ABILITY_STYGIAN },
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .iconPalIndex = 2,
        .iconPalette = gMonIconPalette_Noctowl,
        .shinyIconPalette = gMonShinyIconPalette_Noctowl,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_LEDYBA] =
    {
        ...
        .iconPalIndex = 0,
        .iconPalette = gMonIconPalette_Ledyba,
        .shinyIconPalette = gMonShinyIconPalette_Ledyba,
#if P_GENDER_DIFFERENCES && !P_GBA_STYLE_SPECIES_GFX
    ...
    [SPECIES_LEDIAN] =
    {
        ...
        .innates = { ABILITY_FRIEND_GUARD, ABILITY_TINTED_LENS, ABILITY_DEFIANT },
        .bodyColor = BODY_COLOR_RED,
        ...
        .iconPalIndex = 0,
        .iconPalette = gMonIconPalette_Ledian,
        .shinyIconPalette = gMonShinyIconPalette_Ledian,
#if P_GENDER_DIFFERENCES && !P_GBA_STYLE_SPECIES_GFX
    ...
    [SPECIES_SPINARAK] =
    {
        ...
        .iconPalIndex = 1,
        .iconPalette = gMonIconPalette_Spinarak,
        .shinyIconPalette = gMonShinyIconPalette_Spinarak,
        .pokemonJumpType = PKMN_JUMP_TYPE_FAST,
    ...
    [SPECIES_ARIADOS] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_INSOMNIA, ABILITY_SNIPER },
        .innates = { ABILITY_CONSUME, ABILITY_MERCILESS, ABILITY_TOUGH_CLAWS },
        .bodyColor = BODY_COLOR_RED,
        ...
        .iconPalIndex = 0,
        .iconPalette = gMonIconPalette_Ariados,
        .shinyIconPalette = gMonShinyIconPalette_Ariados,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_CHINCHOU] =
    {
        ...
        .innates = { ABILITY_RESTORING, ABILITY_DIVER },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .iconPalIndex = 2,
        .iconPalette = gMonIconPalette_Chinchou,
        .shinyIconPalette = gMonShinyIconPalette_Chinchou,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_LANTURN] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_VOLT_ABSORB, ABILITY_ILLUMINATE, ABILITY_WATER_ABSORB },
        .innates = { ABILITY_RESTORING, ABILITY_DIVER, ABILITY_BATTERY },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .iconPalIndex = 0,
        .iconPalette = gMonIconPalette_Lanturn,
        .shinyIconPalette = gMonShinyIconPalette_Lanturn,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
...
#define TOGEPI_FAMILY_TYPE1 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_TOGEPI] =
    {
        ...
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 2 : 0,
        .iconPalette = gMonIconPalette_Togepi,
        .shinyIconPalette = gMonShinyIconPalette_Togepi,
        .pokemonJumpType = PKMN_JUMP_TYPE_SLOW,
    ...
    [SPECIES_TOGETIC] =
    {
        ...
        .abilities = { ABILITY_HUSTLE, ABILITY_SERENE_GRACE, ABILITY_SUPER_LUCK },
        .innates = { ABILITY_FRIEND_GUARD, ABILITY_MAGIC_GUARD },
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
        ...
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 2 : 0,
        .iconPalette = gMonIconPalette_Togetic,
        .shinyIconPalette = gMonShinyIconPalette_Togetic,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_TOGEKISS] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_HUSTLE, ABILITY_SERENE_GRACE, ABILITY_SUPER_LUCK },
        .innates = { ABILITY_FRIEND_GUARD, ABILITY_MAGIC_GUARD, ABILITY_DAZZLING },
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
    ...
    [SPECIES_NATU] =
    {
        ...
        .iconPalette = gMonIconPalette_Natu,
        .shinyIconPalette = gMonShinyIconPalette_Natu,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_XATU] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_SYNCHRONIZE, ABILITY_EARLY_BIRD, ABILITY_MAGIC_BOUNCE },
        .innates = { ABILITY_SEER, ABILITY_MAGIC_GUARD, ABILITY_COMPETITIVE },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Xatu"),
        .cryId = CRY_XATU,
        ...
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 0 : 1,
        .iconPalette = gMonIconPalette_Xatu,
        .shinyIconPalette = gMonShinyIconPalette_Xatu,
    ...
    [SPECIES_MAREEP] =
    {
        ...
        .abilities = { ABILITY_STATIC, ABILITY_MINUS, ABILITY_PLUS },
        ...
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 2 : 0,
        .iconPalette = gMonIconPalette_Mareep,
        .shinyIconPalette = gMonShinyIconPalette_Mareep,
        .pokemonJumpType = PKMN_JUMP_TYPE_NORMAL,
        SHADOW(1, 1, SHADOW_SIZE_M)
        FOOTPRINT(Mareep)
        OVERWORLD(
    ...
    [SPECIES_FLAAFFY] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_STATIC, ABILITY_MINUS, ABILITY_PLUS },
        .innates = { ABILITY_FLUFFY, ABILITY_COTTON_DOWN },
        ...
        .iconPalIndex = 0,
        .iconPalette = gMonIconPalette_Flaaffy,
        .shinyIconPalette = gMonShinyIconPalette_Flaaffy,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_AMPHAROS] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_STATIC, ABILITY_MINUS, ABILITY_PLUS },
        .innates = { ABILITY_KEEN_EYE, ABILITY_BATTERY, ABILITY_LIGHTNING_ROD },
        .bodyColor = BODY_COLOR_YELLOW,
        ...
        .iconPalIndex = 0,
        .iconPalette = gMonIconPalette_Ampharos,
        .shinyIconPalette = gMonShinyIconPalette_Ampharos,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_AMPHAROS_MEGA] =
    {
        ...
        .innates = { ABILITY_POLARITY_SHIFT, ABILITY_FLUFFY, ABILITY_BATTERY },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Ampharos"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_AZURILL] =
    {
        ...
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 2 : 0,
        .iconPalette = gMonIconPalette_Azurill,
        .shinyIconPalette = gMonShinyIconPalette_Azurill,
        .pokemonJumpType = PKMN_JUMP_TYPE_SLOW,
    ...
    [SPECIES_MARILL] =
    {
        ...
        .abilities = { ABILITY_THICK_FAT, ABILITY_HUGE_POWER, ABILITY_SAP_SIPPER },
        .innates = { ABILITY_CHEEK_POUCH, ABILITY_WATER_VEIL },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 2 : 0,
        .iconPalette = gMonIconPalette_Marill,
        .shinyIconPalette = gMonShinyIconPalette_Marill,
        .pokemonJumpType = PKMN_JUMP_TYPE_SLOW,
        SHADOW(-2, 0, SHADOW_SIZE_S)
        FOOTPRINT(Marill)
        OVERWORLD(
    ...
    [SPECIES_AZUMARILL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_THICK_FAT, ABILITY_HUGE_POWER, ABILITY_SAP_SIPPER },
        .innates = { ABILITY_CHEEK_POUCH, ABILITY_WATER_VEIL, ABILITY_RAIN_DISH },
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
        ...
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 2 : 0,
        .iconPalette = gMonIconPalette_Azumarill,
        .shinyIconPalette = gMonShinyIconPalette_Azumarill,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_SUDOWOODO] =
    {
        ...
        .abilities = { ABILITY_STURDY, ABILITY_ROCK_HEAD, ABILITY_RATTLED },
        .innates = { ABILITY_HEATPROOF, ABILITY_SOLID_ROCK, ABILITY_SAP_SIPPER },
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .iconPalIndex = 1,
        .iconPalette = gMonIconPalette_Sudowoodo,
        .shinyIconPalette = gMonShinyIconPalette_Sudowoodo,
#if P_GENDER_DIFFERENCES && !P_GBA_STYLE_SPECIES_GFX
    ...
    [SPECIES_HOPPIP] =
    {
        ...
        .iconPalIndex = 1,
        .iconPalette = gMonIconPalette_Hoppip,
        .shinyIconPalette = gMonShinyIconPalette_Hoppip,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_SKIPLOOM] =
    {
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_LEAF_GUARD, ABILITY_INFILTRATOR },
        .innates = { ABILITY_WIND_RIDER, ABILITY_COTTON_DOWN },
    #else
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_NONE, ABILITY_INFILTRATOR },
    #endif
        .bodyColor = BODY_COLOR_GREEN,
        ...
        .iconPalIndex = 1,
        .iconPalette = gMonIconPalette_Skiploom,
        .shinyIconPalette = gMonShinyIconPalette_Skiploom,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_JUMPLUFF] =
    {
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_LEAF_GUARD, ABILITY_INFILTRATOR },
        .innates = { ABILITY_WIND_RIDER, ABILITY_PRANKSTER, ABILITY_COTTON_DOWN },
    #else
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_NONE, ABILITY_INFILTRATOR },
    #endif
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .iconPalIndex = 2,
        .iconPalette = gMonIconPalette_Jumpluff,
        .shinyIconPalette = gMonShinyIconPalette_Jumpluff,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_AIPOM] =
    {
        ...
        .iconPalIndex = 2,
        .iconPalette = gMonIconPalette_Aipom,
        .shinyIconPalette = gMonShinyIconPalette_Aipom,
#if P_GENDER_DIFFERENCES && !P_GBA_STYLE_SPECIES_GFX
    ...
    [SPECIES_AMBIPOM] =
    {
        ...
        .innates = { ABILITY_DUAL_STRIKE, ABILITY_LONG_REACH, ABILITY_WARRIOR_SPIRIT },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SUNKERN] =
    {
        ...
        .iconPalIndex = 1,
        .iconPalette = gMonIconPalette_Sunkern,
        .shinyIconPalette = gMonShinyIconPalette_Sunkern,
        .pokemonJumpType = PKMN_JUMP_TYPE_SLOW,
    ...
    [SPECIES_SUNFLORA] =
    {
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_SOLAR_POWER, ABILITY_EARLY_BIRD },
        .innates = { ABILITY_SEED_SOWER, ABILITY_FLOWER_VEIL, ABILITY_DROUGHT },
    #else
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_NONE, ABILITY_EARLY_BIRD },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
        ...
        .iconPalIndex = 1,
        .iconPalette = gMonIconPalette_Sunflora,
        .shinyIconPalette = gMonShinyIconPalette_Sunflora,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_YANMA] =
    {
        ...
        .iconPalIndex = 1,
        .iconPalette = gMonIconPalette_Yanma,
        .shinyIconPalette = gMonShinyIconPalette_Yanma,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(-2, 10, SHADOW_SIZE_S)
        FOOTPRINT(Yanma)
        OVERWORLD(
    ...
    [SPECIES_WOOPER] =
    {
        ...
        .iconPalette = gMonIconPalette_Wooper,
        .shinyIconPalette = gMonShinyIconPalette_Wooper,
#if P_GENDER_DIFFERENCES && !P_GBA_STYLE_SPECIES_GFX
    ...
    [SPECIES_QUAGSIRE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
        .abilities = { ABILITY_DAMP, ABILITY_WATER_ABSORB, ABILITY_UNAWARE },
        .innates = { ABILITY_DRIZZLE, ABILITY_POISON_HEAL, ABILITY_SOLID_ROCK },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .iconPalette = gMonIconPalette_Quagsire,
        .shinyIconPalette = gMonShinyIconPalette_Quagsire,
#if P_GENDER_DIFFERENCES && !P_GBA_STYLE_SPECIES_GFX
    ...
    [SPECIES_CLODSIRE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
        .abilities = { ABILITY_POISON_POINT, ABILITY_WATER_ABSORB, ABILITY_UNAWARE },
        .innates = { ABILITY_POISON_TOUCH, ABILITY_PURIFYING_SALT, ABILITY_EARTH_EATER },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_MURKROW] =
    {
        ...
        .iconPalette = gMonIconPalette_Murkrow,
        .shinyIconPalette = gMonShinyIconPalette_Murkrow,
#if P_GENDER_DIFFERENCES && !P_GBA_STYLE_SPECIES_GFX
    ...
    [SPECIES_HONCHKROW] =
    {
        ...
        .innates = { ABILITY_STAKEOUT, ABILITY_DARK_AURA, ABILITY_SUPREME_OVERLORD },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_MISDREAVUS] =
    {
        ...
        .innates = { ABILITY_CURSED_BODY, ABILITY_LIFESTEAL },
        ...
        .iconPalIndex = 0,
        .iconPalette = gMonIconPalette_Misdreavus,
        .shinyIconPalette = gMonShinyIconPalette_Misdreavus,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_MISMAGIUS] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_LEVITATE, ABILITY_NONE, ABILITY_NONE },
        .innates = { ABILITY_HAUNTING, ABILITY_LIFESTEAL, ABILITY_SPECTRAL },
        .bodyColor = BODY_COLOR_PURPLE,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    {                                                                                                   \
        ...
        .iconPalIndex = 0,                                                                              \
        .iconPalette = gMonIconPalette_Unown,                                                           \
        .shinyIconPalette = gMonShinyIconPalette_Unown,                                                 \
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,                                                         \
    ...
    [SPECIES_WYNAUT] =
    {
        ...
        .innates = { ABILITY_FRIEND_GUARD, ABILITY_FORCE_RETURN, ABILITY_CURSED_BODY },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .iconPalIndex = 0,
        .iconPalette = gMonIconPalette_Wynaut,
        .shinyIconPalette = gMonShinyIconPalette_Wynaut,
        .pokemonJumpType = PKMN_JUMP_TYPE_NORMAL,
        SHADOW(-1, 2, SHADOW_SIZE_S)
        FOOTPRINT(Wynaut)
        OVERWORLD(
    ...
    [SPECIES_WOBBUFFET] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_SHADOW_TAG, ABILITY_NONE, ABILITY_TELEPATHY },
        .innates = { ABILITY_FRIEND_GUARD, ABILITY_MIRROR_ARMOR },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .iconPalette = gMonIconPalette_Wobbuffet,
        .shinyIconPalette = gMonShinyIconPalette_Wobbuffet,
#if P_GENDER_DIFFERENCES && !P_GBA_STYLE_SPECIES_GFX
    ...
    [SPECIES_GIRAFARIG] =
    {
        ...
        .innates = { ABILITY_FOREWARN, ABILITY_RATTLED, ABILITY_INVERSION },
        .bodyColor = BODY_COLOR_YELLOW,
        ...
        .iconPalette = gMonIconPalette_Girafarig,
        .shinyIconPalette = gMonShinyIconPalette_Girafarig,
#if P_GENDER_DIFFERENCES && !P_GBA_STYLE_SPECIES_GFX
    ...
    [SPECIES_FARIGIRAF] =
    {
        ...
        .innates = { ABILITY_PSYCHIC_SURGE, ABILITY_INNER_FOCUS, ABILITY_INVERSION },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_PINECO] =
    {
        ...
        .iconPalIndex = 0,
        .iconPalette = gMonIconPalette_Pineco,
        .shinyIconPalette = gMonShinyIconPalette_Pineco,
        .pokemonJumpType = PKMN_JUMP_TYPE_SLOW,
        SHADOW(0, 2, SHADOW_SIZE_S)
        FOOTPRINT(Pineco)
        OVERWORLD(
    ...
    [SPECIES_FORRETRESS] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_STURDY, ABILITY_NONE, ABILITY_OVERCOAT },
        .innates = { ABILITY_BATTLE_ARMOR, ABILITY_IRON_BARBS, ABILITY_STEELWORKER },
        .bodyColor = BODY_COLOR_PURPLE,
        ...
        .iconPalIndex = 2,
        .iconPalette = gMonIconPalette_Forretress,
        .shinyIconPalette = gMonShinyIconPalette_Forretress,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_DUNSPARCE] =
    {
        ...
        .innates = { ABILITY_SIMPLE, ABILITY_BURROWER },
        .bodyColor = BODY_COLOR_YELLOW,
        ...
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 2 : 0,
        .iconPalette = gMonIconPalette_Dunsparce,
        .shinyIconPalette = gMonShinyIconPalette_Dunsparce,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_DUDUNSPARCE_TWO_SEGMENT] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SERENE_GRACE, ABILITY_RUN_AWAY, ABILITY_RATTLED },
        .innates = { ABILITY_SIMPLE, ABILITY_BURROWER, ABILITY_ENIGMA },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_GLIGAR] =
    {
        ...
        .iconPalette = gMonIconPalette_Gligar,
        .shinyIconPalette = gMonShinyIconPalette_Gligar,
#if P_GENDER_DIFFERENCES && !P_GBA_STYLE_SPECIES_GFX
    ...
    [SPECIES_GLISCOR] =
    {
        ...
        .innates = { ABILITY_POISON_TOUCH, ABILITY_TOUGH_CLAWS, ABILITY_ROUGH_SKIN },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SNUBBULL] =
    {
        ...
        .iconPalIndex = 0,
        .iconPalette = gMonIconPalette_Snubbull,
        .shinyIconPalette = gMonShinyIconPalette_Snubbull,
        .pokemonJumpType = PKMN_JUMP_TYPE_NORMAL,
    ...
    [SPECIES_GRANBULL] =
    {
        ...
        .innates = { ABILITY_GUARD_DOG, ABILITY_STRONG_JAW, ABILITY_TOUGH_CLAWS },
    #else
        ...
        .iconPalIndex = 2,
        .iconPalette = gMonIconPalette_Granbull,
        .shinyIconPalette = gMonShinyIconPalette_Granbull,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_QWILFISH] =
    {
        ...
        .innates = { ABILITY_MERCILESS, ABILITY_TOXIC_DEBRIS, ABILITY_AFTERMATH },
        .bodyColor = BODY_COLOR_GRAY,
        ...
        .iconPalIndex = 0,
        .iconPalette = gMonIconPalette_Qwilfish,
        .shinyIconPalette = gMonShinyIconPalette_Qwilfish,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_QWILFISH_HISUI] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_POISON_POINT, ABILITY_SWIFT_SWIM, ABILITY_INTIMIDATE },
        .innates = { ABILITY_MERCILESS, ABILITY_TOXIC_DEBRIS },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
        .speciesName = _("Qwilfish"),
        .cryId = CRY_QWILFISH,
    ...
    [SPECIES_SHUCKLE] =
    {
        ...
        .innates = { ABILITY_SOLID_ROCK, ABILITY_FILTER, ABILITY_PASTEL_VEIL },
    #else
        ...
        .iconPalIndex = 1,
        .iconPalette = gMonIconPalette_Shuckle,
        .shinyIconPalette = gMonShinyIconPalette_Shuckle,
        .pokemonJumpType = PKMN_JUMP_TYPE_SLOW,
    ...
    [SPECIES_HERACROSS] =
    {
        ...
        .innates = { ABILITY_SKILL_LINK, ABILITY_TOUGH_CLAWS, ABILITY_DEFIANT },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .iconPalette = gMonIconPalette_Heracross,
        .shinyIconPalette = gMonShinyIconPalette_Heracross,
#if P_GENDER_DIFFERENCES && !P_GBA_STYLE_SPECIES_GFX
    ...
    [SPECIES_HERACROSS_MEGA] =
    {
        ...
        .innates = { ABILITY_GUTS, ABILITY_MOXIE, ABILITY_TOUGH_CLAWS },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Heracross"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_SNEASEL] =
    {
        ...
        .iconPalette = gMonIconPalette_Sneasel,
        .shinyIconPalette = gMonShinyIconPalette_Sneasel,
#if P_GENDER_DIFFERENCES && !P_GBA_STYLE_SPECIES_GFX
    ...
    [SPECIES_WEAVILE] =
    {
        ...
        .innates = { ABILITY_TOUGH_CLAWS, ABILITY_TECHNICIAN, ABILITY_PACK_LEADER },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_SNEASLER] =
    {
        ...
        .innates = { ABILITY_TOUGH_CLAWS, ABILITY_MERCILESS, ABILITY_PACK_LEADER },
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
    ...
    [SPECIES_TEDDIURSA] =
    {
        ...
        .iconPalIndex = 0,
        .iconPalette = gMonIconPalette_Teddiursa,
        .shinyIconPalette = gMonShinyIconPalette_Teddiursa,
        .pokemonJumpType = PKMN_JUMP_TYPE_NORMAL,
    ...
    [SPECIES_URSARING] =
    {
        ...
        .iconPalette = gMonIconPalette_Ursaring,
        .shinyIconPalette = gMonShinyIconPalette_Ursaring,
#if P_GENDER_DIFFERENCES && !P_GBA_STYLE_SPECIES_GFX
    ...
    [SPECIES_URSALUNA] =
    {
        ...
        .innates = { ABILITY_STRONG_JAW, ABILITY_STAMINA, ABILITY_EARTH_EATER },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
    ...
    [SPECIES_URSALUNA_BLOODMOON] =
    {
        ...
        .innates = { ABILITY_BERSERK, ABILITY_FUR_COAT, ABILITY_BULLETPROOF },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
        .speciesName = _("Ursaluna"),
    ...
    [SPECIES_SLUGMA] =
    {
        ...
        .iconPalIndex = 0,
        .iconPalette = gMonIconPalette_Slugma,
        .shinyIconPalette = gMonShinyIconPalette_Slugma,
        .pokemonJumpType = PKMN_JUMP_TYPE_SLOW,
    ...
    [SPECIES_MAGCARGO] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_MAGMA_ARMOR, ABILITY_FLAME_BODY, ABILITY_WEAK_ARMOR },
        .innates = { ABILITY_SOLID_ROCK, ABILITY_FILTER, ABILITY_EARTH_EATER },
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
        ...
        .iconPalIndex = 0,
        .iconPalette = gMonIconPalette_Magcargo,
        .shinyIconPalette = gMonShinyIconPalette_Magcargo,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_SWINUB] =
    {
        ...
        .iconPalIndex = 2,
        .iconPalette = gMonIconPalette_Swinub,
        .shinyIconPalette = gMonShinyIconPalette_Swinub,
        .pokemonJumpType = PKMN_JUMP_TYPE_NORMAL,
    ...
    [SPECIES_PILOSWINE] =
    {
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_SNOW_CLOAK, ABILITY_THICK_FAT },
        .innates = { ABILITY_PERMAFROST, ABILITY_STAMINA },
    #else
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_NONE, ABILITY_THICK_FAT },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .iconPalette = gMonIconPalette_Piloswine,
        .shinyIconPalette = gMonShinyIconPalette_Piloswine,
#if P_GENDER_DIFFERENCES && !P_GBA_STYLE_SPECIES_GFX
    ...
    [SPECIES_MAMOSWINE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_SNOW_CLOAK, ABILITY_THICK_FAT },
        .innates = { ABILITY_PERMAFROST, ABILITY_STAMINA, ABILITY_SLUSH_RUSH },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_CORSOLA] =
    {
        ...
        .innates = { ABILITY_REEF_WARDEN, ABILITY_WATER_COMPACTION, ABILITY_PASTEL_VEIL  },
        .bodyColor = BODY_COLOR_PINK,
        ...
        .iconPalIndex = 0,
        .iconPalette = gMonIconPalette_Corsola,
        .shinyIconPalette = gMonShinyIconPalette_Corsola,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_CORSOLA_GALAR] =
    {
        ...
        .innates = { ABILITY_REEF_WARDEN, ABILITY_WANDERING_SPIRIT, ABILITY_PERISH_BODY },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Corsola"),
        .cryId = CRY_CORSOLA,
        .natDexNum = NATIONAL_DEX_CORSOLA,
    ...
    [SPECIES_CURSOLA] =
    {
        ...
        .innates = { ABILITY_REEF_WARDEN, ABILITY_SOUL_HEART, ABILITY_SHADOW_SHIELD },
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
    ...
    [SPECIES_REMORAID] =
    {
        ...
        .iconPalIndex = 0,
        .iconPalette = gMonIconPalette_Remoraid,
        .shinyIconPalette = gMonShinyIconPalette_Remoraid,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_OCTILLERY] =
    {
        ...
        .innates = { ABILITY_MEGA_LAUNCHER, ABILITY_STICKY_HOLD, ABILITY_BULLETPROOF },
    #else
        ...
        .iconPalette = gMonIconPalette_Octillery,
        .shinyIconPalette = gMonShinyIconPalette_Octillery,
#if P_GENDER_DIFFERENCES && !P_GBA_STYLE_SPECIES_GFX
    ...
    [SPECIES_DELIBIRD] =
    {
        ...
        .innates = { ABILITY_UNBURDEN, ABILITY_QUICK_DRAW, ABILITY_REFRIGERATE },
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
        ...
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 0 : 1,
        .iconPalette = gMonIconPalette_Delibird,
        .shinyIconPalette = gMonShinyIconPalette_Delibird,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_MANTYKE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_REEF_WARDEN, ABILITY_WATER_VEIL },
    ...
    [SPECIES_MANTINE] =
    {
        ...
        .innates = { ABILITY_HYDRATION, ABILITY_REEF_WARDEN, ABILITY_FILTER },
        .bodyColor = BODY_COLOR_PURPLE,
        ...
        .iconPalIndex = 2,
        .iconPalette = gMonIconPalette_Mantine,
        .shinyIconPalette = gMonShinyIconPalette_Mantine,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_SKARMORY] =
    {
        ...
        .innates = { ABILITY_BATTLE_ARMOR, ABILITY_MIRROR_ARMOR, ABILITY_PHALANX },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_SKARMORY_MEGA] =
    {
        ...
        .innates = { ABILITY_TOUGH_CLAWS, ABILITY_MIRROR_ARMOR, ABILITY_PHALANX },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Skarmory"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_HOUNDOUR] =
    {
        ...
        .iconPalIndex = 0,
        .iconPalette = gMonIconPalette_Houndour,
        .shinyIconPalette = gMonShinyIconPalette_Houndour,
        .pokemonJumpType = PKMN_JUMP_TYPE_FAST,
        SHADOW(0, 4, SHADOW_SIZE_M)
        FOOTPRINT(Houndour)
        OVERWORLD(
    ...
    [SPECIES_HOUNDOOM] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_EARLY_BIRD, ABILITY_FLASH_FIRE, ABILITY_UNNERVE },
        .innates = { ABILITY_BRAND_OF_TORMENT, ABILITY_STRONG_JAW, ABILITY_BRIMSTONE },
        .bodyColor = BODY_COLOR_BLACK,
        ...
        .iconPalette = gMonIconPalette_Houndoom,
        .shinyIconPalette = gMonShinyIconPalette_Houndoom,
#if P_GENDER_DIFFERENCES && !P_GBA_STYLE_SPECIES_GFX
    ...
    [SPECIES_HOUNDOOM_MEGA] =
    {
        ...
        .innates = { ABILITY_BRAND_OF_TORMENT, ABILITY_DARK_AURA, ABILITY_BRIMSTONE },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Houndoom"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_PHANPY] =
    {
        ...
        .iconPalIndex = 0,
        .iconPalette = gMonIconPalette_Phanpy,
        .shinyIconPalette = gMonShinyIconPalette_Phanpy,
        .pokemonJumpType = PKMN_JUMP_TYPE_NORMAL,
    ...
    [SPECIES_DONPHAN] =
    {
        ...
        .innates = { ABILITY_ROLLING_STONE, ABILITY_STAMINA, ABILITY_SANDSHIELD },
        .bodyColor = BODY_COLOR_GRAY,
        ...
        .iconPalIndex = 0,
        .iconPalette = gMonIconPalette_Donphan,
        .shinyIconPalette = gMonShinyIconPalette_Donphan,
#if P_GENDER_DIFFERENCES && !P_GBA_STYLE_SPECIES_GFX
    ...
    [SPECIES_STANTLER] =
    {
        ...
        .innates = { ABILITY_FOREWARN, ABILITY_RATTLED },
    #else
        ...
        .iconPalIndex = 2,
        .iconPalette = gMonIconPalette_Stantler,
        .shinyIconPalette = gMonShinyIconPalette_Stantler,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_WYRDEER] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_FRISK, ABILITY_SAP_SIPPER },
        .innates = { ABILITY_NEUROFORCE, ABILITY_PSYCHIC_SURGE, ABILITY_GUARD_DOG },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_SMEARGLE] =
    {
        ...
        .innates = { ABILITY_COLOR_CHANGE, ABILITY_MAGICIAN, ABILITY_SYMBIOSIS },
    #else
        ...
        .iconPalIndex = 1,
        .iconPalette = gMonIconPalette_Smeargle,
        .shinyIconPalette = gMonShinyIconPalette_Smeargle,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_MILTANK] =
    {
        ...
        .innates = { ABILITY_STAMINA, ABILITY_SHEER_FORCE, ABILITY_GRASS_PELT },
    #else
        ...
        .iconPalette = gMonIconPalette_Miltank,
        .shinyIconPalette = gMonShinyIconPalette_Miltank,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_RAIKOU] =
    {
        ...
        .iconPalette = gMonIconPalette_Raikou,
        .shinyIconPalette = gMonShinyIconPalette_Raikou,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_ENTEI] =
    {
        ...
        .iconPalIndex = 2,
        .iconPalette = gMonIconPalette_Entei,
        .shinyIconPalette = gMonShinyIconPalette_Entei,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_SUICUNE] =
    {
        ...
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 0 : 2,
        .iconPalette = gMonIconPalette_Suicune,
        .shinyIconPalette = gMonShinyIconPalette_Suicune,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_LARVITAR] =
    {
        ...
        .iconPalIndex = 1,
        .iconPalette = gMonIconPalette_Larvitar,
        .shinyIconPalette = gMonShinyIconPalette_Larvitar,
        .pokemonJumpType = PKMN_JUMP_TYPE_FAST,
        SHADOW(0, 3, SHADOW_SIZE_S)
        FOOTPRINT(Larvitar)
        OVERWORLD(
    ...
    [SPECIES_PUPITAR] =
    {
        ...
        .innates = { ABILITY_BATTLE_ARMOR, ABILITY_SAND_FORCE },
        .bodyColor = BODY_COLOR_GRAY,
        ...
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 0 : 2,
        .iconPalette = gMonIconPalette_Pupitar,
        .shinyIconPalette = gMonShinyIconPalette_Pupitar,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_TYRANITAR] =
    {
        ...
        .iconPalette = gMonIconPalette_Tyranitar,
        .shinyIconPalette = gMonShinyIconPalette_Tyranitar,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_LUGIA] =
    {
        ...
        .iconPalIndex = 0,
        .iconPalette = gMonIconPalette_Lugia,
        .shinyIconPalette = gMonShinyIconPalette_Lugia,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_HO_OH] =
    {
        ...
        .innates = { ABILITY_FLAME_BODY, ABILITY_FLARE, ABILITY_REBORN },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Ho-Oh"),
        .cryId = CRY_HO_OH,
        ...
        .iconPalIndex = 1,
        .iconPalette = gMonIconPalette_HoOh,
        .shinyIconPalette = gMonShinyIconPalette_HoOh,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_CELEBI] =
    {
        ...
        .iconPalIndex = 1,
        .iconPalette = gMonIconPalette_Celebi,
        .shinyIconPalette = gMonShinyIconPalette_Celebi,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
