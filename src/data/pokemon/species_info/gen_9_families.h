...
#define OGERPON_SPECIES_INFO(Form1, Form2, type, ability, color, frontYOffset, iconpalette, isTeraform, megaEvolution, attackBoost, defenseBoost, speedBoost, spDefenseBoost, innate1, innate2, innate3) \
    ...
    [SPECIES_OGERPON_TEAL]             = OGERPON_SPECIES_INFO(Teal,        Teal,            TYPE_GRASS, ABILITY_DEFIANT,                        BODY_COLOR_GREEN, 2, 1, FALSE, FALSE, 0,  0,  0,  0,  ABILITY_SUPER_LUCK, ABILITY_LEAF_GUARD, ABILITY_SHEER_FORCE),
    ...
    [SPECIES_OGERPON_HEARTHFLAME]      = OGERPON_SPECIES_INFO(Hearthflame, Hearthflame,     TYPE_FIRE,  ABILITY_MOLD_BREAKER,                   BODY_COLOR_RED,   2, 0, FALSE, FALSE, 0,  0,  0,  0,  ABILITY_FLASH_FIRE, ABILITY_BLAZING_SUN, ABILITY_SHEER_FORCE),
    [SPECIES_OGERPON_CORNERSTONE]      = OGERPON_SPECIES_INFO(Cornerstone, Cornerstone,     TYPE_ROCK,  ABILITY_STURDY,                         BODY_COLOR_GRAY,  2, 0, FALSE, FALSE, 0,  0,  0,  0,  ABILITY_ROCK_HEAD, ABILITY_STONE_FACE, ABILITY_SHEER_FORCE),
#if P_TERA_FORMS
    ...
    [SPECIES_OGERPON_HEARTHFLAME_TERA] = OGERPON_SPECIES_INFO(Hearthflame, HearthflameTera, TYPE_FIRE,  ABILITY_EMBODY_ASPECT_HEARTHFLAME_MASK, BODY_COLOR_RED,   0, 0, TRUE, TRUE,  25, 5, 10, 10, ABILITY_FLASH_FIRE, ABILITY_BRIMSTONE, ABILITY_SHEER_FORCE),
    [SPECIES_OGERPON_CORNERSTONE_TERA] = OGERPON_SPECIES_INFO(Cornerstone, CornerstoneTera, TYPE_ROCK,  ABILITY_EMBODY_ASPECT_CORNERSTONE_MASK, BODY_COLOR_GRAY,  0, 0, TRUE, TRUE,  25, 25, 0,  0,  ABILITY_ROCK_HEAD, ABILITY_STONE_FACE, ABILITY_SHEER_FORCE),
#endif //P_TERA_FORMS
