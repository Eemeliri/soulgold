...
const u8 gText_Second_PM[] = _("Seond");
...
const u8 gText_RunOptionDisabled[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Disabled");
const u8 gText_RunOptionEnabled1[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{L_BUTTON}+{R_BUTTON}+{A_BUTTON}");
const u8 gText_RunOptionEnabled2[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{B_BUTTON}");
...
const u8 gText_PSS[] = _("Move Split");
const u8 gText_Terrain[] = _("Terrain");
...
const u8 gText_MusicSinnoh[]= _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Gen IV");
