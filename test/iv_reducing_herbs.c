...
{
    { ITEM_WITHERED_HERB, MON_DATA_HP_IV,    ITEM_EFFECT_HP_IV_REDUCE,    COMPOUND_STRING("Withered Herb") },
    { ITEM_GRIMY_HERB,    MON_DATA_ATK_IV,   ITEM_EFFECT_ATK_IV_REDUCE,   COMPOUND_STRING("Grimy Herb") },
    { ITEM_BRITTLE_HERB,  MON_DATA_DEF_IV,   ITEM_EFFECT_DEF_IV_REDUCE,   COMPOUND_STRING("Brittle Herb") },
    { ITEM_GOOPY_HERB,    MON_DATA_SPEED_IV, ITEM_EFFECT_SPEED_IV_REDUCE, COMPOUND_STRING("Goopy Herb") },
    { ITEM_DULL_HERB,     MON_DATA_SPATK_IV, ITEM_EFFECT_SPATK_IV_REDUCE, COMPOUND_STRING("Dull Herb") },
    { ITEM_SOGGY_HERB,    MON_DATA_SPDEF_IV, ITEM_EFFECT_SPDEF_IV_REDUCE, COMPOUND_STRING("Soggy Herb") },
};
